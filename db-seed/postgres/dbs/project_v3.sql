...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_licenses DROP CONSTRAINT IF EXISTS fk_wtxvkowaoasmyzfvxvufcfbewmisdggpkiww;
...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_producttypes_sites DROP CONSTRAINT IF EXISTS fk_ulixbwgjigsixaochuqunjpeybdzfulegrpa;
...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_products DROP CONSTRAINT IF EXISTS fk_tzuvexgxamvllsduzupgpqogbxoeiygflxle;
...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_products DROP CONSTRAINT IF EXISTS fk_ppleoxacpikfervtzsgtivkbguqctefabrqp;
ALTER TABLE IF EXISTS ONLY public.digitalproducts_producttypes_sites DROP CONSTRAINT IF EXISTS fk_pkuocprdbrpbeioyqgfrtfdpohtjmbdjndus;
...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_products DROP CONSTRAINT IF EXISTS fk_ogmcwsvwlqjfhskaigcizwkovbecauznlwbz;
...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_producttypes DROP CONSTRAINT IF EXISTS fk_nkfsbqygjkujsvrxsfhzkuyqmiymfgkpapmy;
...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_licenses DROP CONSTRAINT IF EXISTS fk_lykgguwllxcrpgistlbzzkrsjeifqzrrsmqi;
...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_licenses DROP CONSTRAINT IF EXISTS fk_libvarcgvvvpngqnjlacleecyldfpapqhzoc;
...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_licenses DROP CONSTRAINT IF EXISTS fk_kacbhabxwlifbnusewuazmccimmraqahhzam;
...
ALTER TABLE IF EXISTS ONLY public.calendar_select_dates DROP CONSTRAINT IF EXISTS "calendar_select_dates_eventId_fk";
ALTER TABLE IF EXISTS ONLY public.calendar_exceptions DROP CONSTRAINT IF EXISTS "calendar_exceptions_eventId_fk";
ALTER TABLE IF EXISTS ONLY public.calendar_events DROP CONSTRAINT IF EXISTS calendar_events_id_fk;
ALTER TABLE IF EXISTS ONLY public.calendar_events DROP CONSTRAINT IF EXISTS "calendar_events_calendarId_fk";
ALTER TABLE IF EXISTS ONLY public.calendar_events DROP CONSTRAINT IF EXISTS "calendar_events_authorId_fk";
ALTER TABLE IF EXISTS ONLY public.calendar_calendars DROP CONSTRAINT IF EXISTS "calendar_calendars_fieldLayoutId_fk";
ALTER TABLE IF EXISTS ONLY public.calendar_calendar_sites DROP CONSTRAINT IF EXISTS "calendar_calendar_sites_siteId_fk";
ALTER TABLE IF EXISTS ONLY public.calendar_calendar_sites DROP CONSTRAINT IF EXISTS "calendar_calendar_sites_calendarId_fk";
...
DROP INDEX IF EXISTS public.idx_xcjnrcbocpbvdetrwjblmzxhywckqlwkkjfi;
...
DROP INDEX IF EXISTS public.idx_wjoycykpvuwgvfthespbgbghknezpahipefx;
...
DROP INDEX IF EXISTS public.idx_ujhdxgzvolwldronpvvdjknzbudmffnlsjyr;
...
DROP INDEX IF EXISTS public.idx_tnevuaaccazvxfailxxuizcrkgooutjtaspl;
...
DROP INDEX IF EXISTS public.idx_rafyzunawtwmkefqmaerofodlcolhontlhch;
DROP INDEX IF EXISTS public.idx_qxckgykpkjrcepslyuzhdmqwwiacksgimqqg;
DROP INDEX IF EXISTS public.idx_qtfydydzbmcxmjgycfxmzgpejfqxzknxriot;
...
DROP INDEX IF EXISTS public.idx_nbnjlsdzdmrkfyxdtglrfzgmcnubzifixgfm;
...
DROP INDEX IF EXISTS public.idx_kugpqcxvzbgvniutoidhtdjzbisbsipxuweg;
...
DROP INDEX IF EXISTS public.idx_icouacerxlwsglrdedtvgzmzxauuucefwhst;
...
DROP INDEX IF EXISTS public.idx_grumxwubmzphkpbufsggaecmkpyzffqeuool;
...
DROP INDEX IF EXISTS public."calendar_select_dates_select_dates_eventId_date_idx";
DROP INDEX IF EXISTS public."calendar_exceptions_exceptions_eventId_date_idx";
DROP INDEX IF EXISTS public.calendar_events_until_idx;
DROP INDEX IF EXISTS public."calendar_events_startDate_idx";
DROP INDEX IF EXISTS public."calendar_events_startDate_endDate_idx";
DROP INDEX IF EXISTS public."calendar_events_postDate_idx";
DROP INDEX IF EXISTS public.calendar_events_id_unq_idx;
DROP INDEX IF EXISTS public."calendar_events_endDate_idx";
DROP INDEX IF EXISTS public."calendar_events_calendarId_idx";
DROP INDEX IF EXISTS public."calendar_events_authorId_idx";
DROP INDEX IF EXISTS public.calendar_calendars_name_unq_idx;
DROP INDEX IF EXISTS public."calendar_calendars_icsHash_unq_idx";
DROP INDEX IF EXISTS public.calendar_calendars_handle_unq_idx;
DROP INDEX IF EXISTS public."calendar_calendar_sites_calendarId_siteId_unq_idx";
...
ALTER TABLE IF EXISTS ONLY public.digitalproducts_producttypes_sites DROP CONSTRAINT IF EXISTS digitalproducts_producttypes_sites_pkey;
ALTER TABLE IF EXISTS ONLY public.digitalproducts_producttypes DROP CONSTRAINT IF EXISTS digitalproducts_producttypes_pkey;
ALTER TABLE IF EXISTS ONLY public.digitalproducts_products DROP CONSTRAINT IF EXISTS digitalproducts_products_pkey;
ALTER TABLE IF EXISTS ONLY public.digitalproducts_licenses DROP CONSTRAINT IF EXISTS digitalproducts_licenses_pkey;
...
ALTER TABLE IF EXISTS ONLY public.calendar_select_dates DROP CONSTRAINT IF EXISTS calendar_select_dates_pkey;
ALTER TABLE IF EXISTS ONLY public.calendar_exceptions DROP CONSTRAINT IF EXISTS calendar_exceptions_pkey;
ALTER TABLE IF EXISTS ONLY public.calendar_events DROP CONSTRAINT IF EXISTS calendar_events_pkey;
ALTER TABLE IF EXISTS ONLY public.calendar_calendars DROP CONSTRAINT IF EXISTS calendar_calendars_pkey;
ALTER TABLE IF EXISTS ONLY public.calendar_calendars DROP CONSTRAINT IF EXISTS calendar_calendars_handle_key;
ALTER TABLE IF EXISTS ONLY public.calendar_calendar_sites DROP CONSTRAINT IF EXISTS calendar_calendar_sites_pkey;
...
ALTER TABLE IF EXISTS public.digitalproducts_producttypes_sites ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.digitalproducts_producttypes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.digitalproducts_products ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.digitalproducts_licenses ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.calendar_select_dates ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.calendar_exceptions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.calendar_events ALTER COLUMN "internalId" DROP DEFAULT;
ALTER TABLE IF EXISTS public.calendar_calendars ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.calendar_calendar_sites ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.digitalproducts_producttypes_sites_id_seq;
DROP TABLE IF EXISTS public.digitalproducts_producttypes_sites;
DROP SEQUENCE IF EXISTS public.digitalproducts_producttypes_id_seq;
DROP TABLE IF EXISTS public.digitalproducts_producttypes;
DROP SEQUENCE IF EXISTS public.digitalproducts_products_id_seq;
DROP TABLE IF EXISTS public.digitalproducts_products;
DROP SEQUENCE IF EXISTS public.digitalproducts_licenses_id_seq;
DROP TABLE IF EXISTS public.digitalproducts_licenses;
...
DROP SEQUENCE IF EXISTS public.calendar_select_dates_id_seq;
DROP TABLE IF EXISTS public.calendar_select_dates;
DROP SEQUENCE IF EXISTS public.calendar_exceptions_id_seq;
DROP TABLE IF EXISTS public.calendar_exceptions;
DROP SEQUENCE IF EXISTS public."calendar_events_internalId_seq";
DROP TABLE IF EXISTS public.calendar_events;
DROP SEQUENCE IF EXISTS public.calendar_calendars_id_seq;
DROP TABLE IF EXISTS public.calendar_calendars;
DROP SEQUENCE IF EXISTS public.calendar_calendar_sites_id_seq;
DROP TABLE IF EXISTS public.calendar_calendar_sites;
...
--
-- Name: calendar_calendar_sites; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.calendar_calendar_sites (
    id integer NOT NULL,
    "calendarId" integer,
    "siteId" integer,
    "enabledByDefault" boolean DEFAULT true,
    "hasUrls" boolean DEFAULT false,
    "uriFormat" character varying(255),
...
--
-- Name: calendar_calendar_sites_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.calendar_calendar_sites_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: calendar_calendar_sites_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.calendar_calendar_sites_id_seq OWNED BY public.calendar_calendar_sites.id;


--
-- Name: calendar_calendars; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.calendar_calendars (
    ...
    "descriptionFieldHandle" character varying(255),
    "locationFieldHandle" character varying(255),
    "icsHash" character varying(255),
    "icsTimezone" character varying(255) DEFAULT NULL::character varying,
    "allowRepeatingEvents" boolean DEFAULT true NOT NULL,
    "dateCreated" timestamp(0) without time zone NOT NULL,
    "dateUpdated" timestamp(0) without time zone NOT NULL,
    uid character(36) DEFAULT '0'::bpchar NOT NULL
);
...
--
-- Name: calendar_calendars_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.calendar_calendars_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: calendar_calendars_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.calendar_calendars_id_seq OWNED BY public.calendar_calendars.id;
...
CREATE TABLE public.calendar_events (
    ...
    "byMonth" character varying(255),
    "byYearDay" character varying(255),
    "byMonthDay" character varying(255),
...
--
-- Name: calendar_events_internalId_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public."calendar_events_internalId_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: calendar_events_internalId_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public."calendar_events_internalId_seq" OWNED BY public.calendar_events."internalId";
...
--
-- Name: calendar_select_dates; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.calendar_select_dates (
    id integer NOT NULL,
    date timestamp(0) without time zone NOT NULL,
    "eventId" integer NOT NULL,
    "dateCreated" timestamp(0) without time zone NOT NULL,
...
--
-- Name: calendar_select_dates_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.calendar_select_dates_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: calendar_select_dates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.calendar_select_dates_id_seq OWNED BY public.calendar_select_dates.id;
...
--
-- Name: digitalproducts_licenses; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.digitalproducts_licenses (
    id integer NOT NULL,
    "productId" integer NOT NULL,
    "orderId" integer,
    "licenseKey" character varying(255) NOT NULL,
    "ownerName" character varying(255),
    "ownerEmail" character varying(255) NOT NULL,
    "userId" integer,
    "dateCreated" timestamp(0) without time zone NOT NULL,
    "dateUpdated" timestamp(0) without time zone NOT NULL,
    uid character(36) DEFAULT '0'::bpchar NOT NULL
...
--
-- Name: digitalproducts_licenses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.digitalproducts_licenses_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: digitalproducts_licenses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.digitalproducts_licenses_id_seq OWNED BY public.digitalproducts_licenses.id;


--
-- Name: digitalproducts_products; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.digitalproducts_products (
    id integer NOT NULL,
...
--
-- Name: digitalproducts_products_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.digitalproducts_products_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: digitalproducts_products_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.digitalproducts_products_id_seq OWNED BY public.digitalproducts_products.id;


--
-- Name: digitalproducts_producttypes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.digitalproducts_producttypes (
    id integer NOT NULL,
    "fieldLayoutId" integer,
    name character varying(255) NOT NULL,
    handle character varying(255) NOT NULL,
...
--
-- Name: digitalproducts_producttypes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.digitalproducts_producttypes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: digitalproducts_producttypes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.digitalproducts_producttypes_id_seq OWNED BY public.digitalproducts_producttypes.id;


--
-- Name: digitalproducts_producttypes_sites; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.digitalproducts_producttypes_sites (
    id integer NOT NULL,
    "productTypeId" integer NOT NULL,
    "siteId" integer NOT NULL,
    "uriFormat" text,
...
--
-- Name: digitalproducts_producttypes_sites_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.digitalproducts_producttypes_sites_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: digitalproducts_producttypes_sites_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.digitalproducts_producttypes_sites_id_seq OWNED BY public.digitalproducts_producttypes_sites.id;
...
--
-- Name: calendar_calendar_sites id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_calendar_sites ALTER COLUMN id SET DEFAULT nextval('public.calendar_calendar_sites_id_seq'::regclass);


--
-- Name: calendar_calendars id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_calendars ALTER COLUMN id SET DEFAULT nextval('public.calendar_calendars_id_seq'::regclass);


--
-- Name: calendar_events internalId; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_events ALTER COLUMN "internalId" SET DEFAULT nextval('public."calendar_events_internalId_seq"'::regclass);
...
--
-- Name: calendar_select_dates id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_select_dates ALTER COLUMN id SET DEFAULT nextval('public.calendar_select_dates_id_seq'::regclass);
...
--
-- Name: digitalproducts_licenses id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_licenses ALTER COLUMN id SET DEFAULT nextval('public.digitalproducts_licenses_id_seq'::regclass);


--
-- Name: digitalproducts_products id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_products ALTER COLUMN id SET DEFAULT nextval('public.digitalproducts_products_id_seq'::regclass);


--
-- Name: digitalproducts_producttypes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_producttypes ALTER COLUMN id SET DEFAULT nextval('public.digitalproducts_producttypes_id_seq'::regclass);


--
-- Name: digitalproducts_producttypes_sites id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_producttypes_sites ALTER COLUMN id SET DEFAULT nextval('public.digitalproducts_producttypes_sites_id_seq'::regclass);
...
--
-- Data for Name: calendar_calendar_sites; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.calendar_calendar_sites (id, "calendarId", "siteId", "enabledByDefault", "hasUrls", "uriFormat", template, "dateCreated", "dateUpdated", uid) VALUES (1, 1, 2, true, false, NULL, NULL, '2022-03-17 16:37:49', '2022-03-17 16:37:49', '815c4fd2-6502-4d25-8605-4d74668e8b0d');
INSERT INTO public.calendar_calendar_sites (id, "calendarId", "siteId", "enabledByDefault", "hasUrls", "uriFormat", template, "dateCreated", "dateUpdated", uid) VALUES (2, 1, 1, true, false, NULL, NULL, '2022-03-17 16:37:49', '2022-03-17 16:37:49', 'aae92448-744c-47d9-9847-843c19e64d1b');


--
-- Data for Name: calendar_calendars; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.calendar_calendars (id, name, handle, description, color, "fieldLayoutId", "titleFormat", "titleLabel", "hasTitleField", "descriptionFieldHandle", "locationFieldHandle", "icsHash", "icsTimezone", "allowRepeatingEvents", "dateCreated", "dateUpdated", uid) VALUES (1, 'Default', 'default', 'The default calendar', '#9E31C4', NULL, NULL, 'Title', true, NULL, NULL, NULL, 'floating', true, '2022-03-17 16:37:49', '2022-03-17 16:37:49', '550b07f1-ec7b-4dfa-8dd6-373f9f2b6598');
...
--
-- Data for Name: calendar_exceptions; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: calendar_select_dates; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.categories (id, "groupId", "parentId", "deletedWithGroup", "dateCreated", "dateUpdated", uid) VALUES (9, 1, NULL, NULL, '2021-04-01 02:58:45', '2021-04-01 02:58:45', 'e8b7d3c8-d271-4946-9dd8-12de3ecde317');
INSERT INTO public.categories (id, "groupId", "parentId", "deletedWithGroup", "dateCreated", "dateUpdated", uid) VALUES (10, 1, NULL, NULL, '2021-04-01 02:58:52', '2021-04-01 02:58:52', '1162addf-7250-4283-9404-6d8a5b030e4c');
...
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (11, 7, 2, 'My first blog', '2021-03-15 16:31:04', '2021-03-15 16:31:04', 'ed5f5148-9f79-4fda-8419-e0f3367eed2a', NULL, 'Some plain text', '<p>Some rich text</p>', '{"bundleVersion":"1.0.22","sourceBundleType":"field","sourceId":null,"sourceName":null,"sourceHandle":null,"sourceType":"field","typeId":null,"sourceTemplate":"","sourceSiteId":null,"sourceAltSiteSettings":[],"sourceDateUpdated":"2021-03-15T12:30:42-04:00","metaGlobalVars":{"language":null,"mainEntityOfPage":"","seoTitle":"","siteNamePosition":"","seoDescription":"","seoKeywords":"","seoImage":"","seoImageWidth":"","seoImageHeight":"","seoImageDescription":"","canonicalUrl":"","robots":"","ogType":"","ogTitle":"","ogSiteNamePosition":"","ogDescription":"","ogImage":"","ogImageWidth":"","ogImageHeight":"","ogImageDescription":"","twitterCard":"","twitterCreator":"","twitterTitle":"","twitterSiteNamePosition":"","twitterDescription":"","twitterImage":"","twitterImageWidth":"","twitterImageHeight":"","twitterImageDescription":""},"metaSiteVars":{"siteName":"Project","identity":null,"creator":null,"twitterHandle":"","facebookProfileId":"","facebookAppId":"","googleSiteVerification":"","bingSiteVerification":"","pinterestSiteVerification":"","sameAsLinks":[],"siteLinksSearchTarget":"","siteLinksQueryInput":"","referrer":"no-referrer-when-downgrade","additionalSitemapUrls":[],"additionalSitemapUrlsDateUpdated":null,"additionalSitemaps":[]},"metaSitemapVars":{"sitemapUrls":true,"sitemapAssets":true,"sitemapFiles":true,"sitemapAltLinks":true,"sitemapChangeFreq":"weekly","sitemapPriority":0.5,"sitemapLimit":null,"structureDepth":null,"sitemapImageFieldMap":[],"sitemapVideoFieldMap":[]},"metaContainers":{"MetaTagContainergeneral":{"data":[],"name":"General","description":"General Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTagContaineropengraph":{"data":[],"name":"Facebook","description":"Facebook OpenGraph Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"opengraph","include":true,"dependencies":[],"clearCache":false},"MetaTagContainertwitter":{"data":[],"name":"Twitter","description":"Twitter Card Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"twitter","include":true,"dependencies":[],"clearCache":false},"MetaTagContainermiscellaneous":{"data":[],"name":"Miscellaneous","description":"Miscellaneous Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"miscellaneous","include":true,"dependencies":[],"clearCache":false},"MetaLinkContainergeneral":{"data":[],"name":"General","description":"Link Tags","class":"nystudio107\\seomatic\\models\\MetaLinkContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaScriptContainergeneral":{"data":[],"position":1,"name":"General","description":"Script Tags","class":"nystudio107\\seomatic\\models\\MetaScriptContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaJsonLdContainergeneral":{"data":[],"name":"General","description":"JsonLd Tags","class":"nystudio107\\seomatic\\models\\MetaJsonLdContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTitleContainergeneral":{"data":[],"name":"General","description":"Meta Title Tag","class":"nystudio107\\seomatic\\models\\MetaTitleContainer","handle":"general","include":true,"dependencies":[],"clearCache":false}},"redirectsContainer":[],"frontendTemplatesContainer":{"data":[],"name":null,"description":null,"class":"nystudio107\\seomatic\\models\\FrontendTemplateContainer","handle":null,"include":true,"dependencies":null,"clearCache":false},"metaBundleSettings":{"siteType":"","siteSubType":"","siteSpecificType":"","seoTitleSource":"fromCustom","seoTitleField":"","siteNamePositionSource":"sameAsGlobal","seoDescriptionSource":"fromCustom","seoDescriptionField":"","seoKeywordsSource":"fromCustom","seoKeywordsField":"","seoImageIds":[],"seoImageSource":"fromAsset","seoImageField":"","seoImageTransform":true,"seoImageTransformMode":"crop","seoImageDescriptionSource":"fromCustom","seoImageDescriptionField":"","twitterCreatorSource":"sameAsSite","twitterCreatorField":"","twitterTitleSource":"sameAsSeo","twitterTitleField":"","twitterSiteNamePositionSource":"sameAsGlobal","twitterDescriptionSource":"sameAsSeo","twitterDescriptionField":"","twitterImageIds":[],"twitterImageSource":"sameAsSeo","twitterImageField":"","twitterImageTransform":true,"twitterImageTransformMode":"crop","twitterImageDescriptionSource":"sameAsSeo","twitterImageDescriptionField":"","ogTitleSource":"sameAsSeo","ogTitleField":"","ogSiteNamePositionSource":"sameAsGlobal","ogDescriptionSource":"sameAsSeo","ogDescriptionField":"","ogImageIds":[],"ogImageSource":"sameAsSeo","ogImageField":"","ogImageTransform":true,"ogImageTransformMode":"crop","ogImageDescriptionSource":"sameAsSeo","ogImageDescriptionField":""}}', NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (3, 4, 1, NULL, '2021-03-15 16:25:51', '2022-03-17 16:37:50', '28ef8ae9-f473-44e7-b83a-bfbba799b649', NULL, 'Some global plain text', '<p>Some global rich text</p>', NULL, NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (4, 4, 2, NULL, '2021-03-15 16:25:51', '2022-03-17 16:37:50', '012d2730-836f-4ac3-8a75-7793da4d727a', NULL, 'Some global plain text', '<p>Some global rich text</p>', NULL, NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (12, 8, 1, 'My first blog', '2021-03-15 16:32:15', '2021-03-15 16:32:15', '99396f28-757e-4652-9ee7-7d6af63bbc11', NULL, 'Some plain text', '<p>Some rich text</p>', '{"bundleVersion":"1.0.22","sourceBundleType":"field","sourceId":null,"sourceName":null,"sourceHandle":null,"sourceType":"field","typeId":null,"sourceTemplate":"","sourceSiteId":null,"sourceAltSiteSettings":[],"sourceDateUpdated":"2021-03-15T12:30:42-04:00","metaGlobalVars":{"language":null,"mainEntityOfPage":"","seoTitle":"","siteNamePosition":"","seoDescription":"","seoKeywords":"","seoImage":"","seoImageWidth":"","seoImageHeight":"","seoImageDescription":"","canonicalUrl":"","robots":"","ogType":"","ogTitle":"","ogSiteNamePosition":"","ogDescription":"","ogImage":"","ogImageWidth":"","ogImageHeight":"","ogImageDescription":"","twitterCard":"","twitterCreator":"","twitterTitle":"","twitterSiteNamePosition":"","twitterDescription":"","twitterImage":"","twitterImageWidth":"","twitterImageHeight":"","twitterImageDescription":""},"metaSiteVars":{"siteName":"Project","identity":null,"creator":null,"twitterHandle":"","facebookProfileId":"","facebookAppId":"","googleSiteVerification":"","bingSiteVerification":"","pinterestSiteVerification":"","sameAsLinks":[],"siteLinksSearchTarget":"","siteLinksQueryInput":"","referrer":"no-referrer-when-downgrade","additionalSitemapUrls":[],"additionalSitemapUrlsDateUpdated":null,"additionalSitemaps":[]},"metaSitemapVars":{"sitemapUrls":true,"sitemapAssets":true,"sitemapFiles":true,"sitemapAltLinks":true,"sitemapChangeFreq":"weekly","sitemapPriority":0.5,"sitemapLimit":null,"structureDepth":null,"sitemapImageFieldMap":[],"sitemapVideoFieldMap":[]},"metaContainers":{"MetaTagContainergeneral":{"data":[],"name":"General","description":"General Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTagContaineropengraph":{"data":[],"name":"Facebook","description":"Facebook OpenGraph Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"opengraph","include":true,"dependencies":[],"clearCache":false},"MetaTagContainertwitter":{"data":[],"name":"Twitter","description":"Twitter Card Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"twitter","include":true,"dependencies":[],"clearCache":false},"MetaTagContainermiscellaneous":{"data":[],"name":"Miscellaneous","description":"Miscellaneous Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"miscellaneous","include":true,"dependencies":[],"clearCache":false},"MetaLinkContainergeneral":{"data":[],"name":"General","description":"Link Tags","class":"nystudio107\\seomatic\\models\\MetaLinkContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaScriptContainergeneral":{"data":[],"position":1,"name":"General","description":"Script Tags","class":"nystudio107\\seomatic\\models\\MetaScriptContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaJsonLdContainergeneral":{"data":[],"name":"General","description":"JsonLd Tags","class":"nystudio107\\seomatic\\models\\MetaJsonLdContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTitleContainergeneral":{"data":[],"name":"General","description":"Meta Title Tag","class":"nystudio107\\seomatic\\models\\MetaTitleContainer","handle":"general","include":true,"dependencies":[],"clearCache":false}},"redirectsContainer":[],"frontendTemplatesContainer":{"data":[],"name":null,"description":null,"class":"nystudio107\\seomatic\\models\\FrontendTemplateContainer","handle":null,"include":true,"dependencies":null,"clearCache":false},"metaBundleSettings":{"siteType":"","siteSubType":"","siteSpecificType":"","seoTitleSource":"fromCustom","seoTitleField":"","siteNamePositionSource":"sameAsGlobal","seoDescriptionSource":"fromCustom","seoDescriptionField":"","seoKeywordsSource":"fromCustom","seoKeywordsField":"","seoImageIds":[],"seoImageSource":"fromAsset","seoImageField":"","seoImageTransform":true,"seoImageTransformMode":"crop","seoImageDescriptionSource":"fromCustom","seoImageDescriptionField":"","twitterCreatorSource":"sameAsSite","twitterCreatorField":"","twitterTitleSource":"sameAsSeo","twitterTitleField":"","twitterSiteNamePositionSource":"sameAsGlobal","twitterDescriptionSource":"sameAsSeo","twitterDescriptionField":"","twitterImageIds":[],"twitterImageSource":"sameAsSeo","twitterImageField":"","twitterImageTransform":true,"twitterImageTransformMode":"crop","twitterImageDescriptionSource":"sameAsSeo","twitterImageDescriptionField":"","ogTitleSource":"sameAsSeo","ogTitleField":"","ogSiteNamePositionSource":"sameAsGlobal","ogDescriptionSource":"sameAsSeo","ogDescriptionField":"","ogImageIds":[],"ogImageSource":"sameAsSeo","ogImageField":"","ogImageTransform":true,"ogImageTransformMode":"crop","ogImageDescriptionSource":"sameAsSeo","ogImageDescriptionField":""}}', NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (13, 8, 2, 'My first blog', '2021-03-15 16:32:15', '2021-03-15 16:32:15', '5b05a01d-3de0-43d3-a3fb-2f4781ec4c16', NULL, 'Some plain text', '<p>Some rich text</p>', '{"bundleVersion":"1.0.22","sourceBundleType":"field","sourceId":null,"sourceName":null,"sourceHandle":null,"sourceType":"field","typeId":null,"sourceTemplate":"","sourceSiteId":null,"sourceAltSiteSettings":[],"sourceDateUpdated":"2021-03-15T12:30:42-04:00","metaGlobalVars":{"language":null,"mainEntityOfPage":"","seoTitle":"","siteNamePosition":"","seoDescription":"","seoKeywords":"","seoImage":"","seoImageWidth":"","seoImageHeight":"","seoImageDescription":"","canonicalUrl":"","robots":"","ogType":"","ogTitle":"","ogSiteNamePosition":"","ogDescription":"","ogImage":"","ogImageWidth":"","ogImageHeight":"","ogImageDescription":"","twitterCard":"","twitterCreator":"","twitterTitle":"","twitterSiteNamePosition":"","twitterDescription":"","twitterImage":"","twitterImageWidth":"","twitterImageHeight":"","twitterImageDescription":""},"metaSiteVars":{"siteName":"Project","identity":null,"creator":null,"twitterHandle":"","facebookProfileId":"","facebookAppId":"","googleSiteVerification":"","bingSiteVerification":"","pinterestSiteVerification":"","sameAsLinks":[],"siteLinksSearchTarget":"","siteLinksQueryInput":"","referrer":"no-referrer-when-downgrade","additionalSitemapUrls":[],"additionalSitemapUrlsDateUpdated":null,"additionalSitemaps":[]},"metaSitemapVars":{"sitemapUrls":true,"sitemapAssets":true,"sitemapFiles":true,"sitemapAltLinks":true,"sitemapChangeFreq":"weekly","sitemapPriority":0.5,"sitemapLimit":null,"structureDepth":null,"sitemapImageFieldMap":[],"sitemapVideoFieldMap":[]},"metaContainers":{"MetaTagContainergeneral":{"data":[],"name":"General","description":"General Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTagContaineropengraph":{"data":[],"name":"Facebook","description":"Facebook OpenGraph Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"opengraph","include":true,"dependencies":[],"clearCache":false},"MetaTagContainertwitter":{"data":[],"name":"Twitter","description":"Twitter Card Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"twitter","include":true,"dependencies":[],"clearCache":false},"MetaTagContainermiscellaneous":{"data":[],"name":"Miscellaneous","description":"Miscellaneous Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"miscellaneous","include":true,"dependencies":[],"clearCache":false},"MetaLinkContainergeneral":{"data":[],"name":"General","description":"Link Tags","class":"nystudio107\\seomatic\\models\\MetaLinkContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaScriptContainergeneral":{"data":[],"position":1,"name":"General","description":"Script Tags","class":"nystudio107\\seomatic\\models\\MetaScriptContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaJsonLdContainergeneral":{"data":[],"name":"General","description":"JsonLd Tags","class":"nystudio107\\seomatic\\models\\MetaJsonLdContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTitleContainergeneral":{"data":[],"name":"General","description":"Meta Title Tag","class":"nystudio107\\seomatic\\models\\MetaTitleContainer","handle":"general","include":true,"dependencies":[],"clearCache":false}},"redirectsContainer":[],"frontendTemplatesContainer":{"data":[],"name":null,"description":null,"class":"nystudio107\\seomatic\\models\\FrontendTemplateContainer","handle":null,"include":true,"dependencies":null,"clearCache":false},"metaBundleSettings":{"siteType":"","siteSubType":"","siteSpecificType":"","seoTitleSource":"fromCustom","seoTitleField":"","siteNamePositionSource":"sameAsGlobal","seoDescriptionSource":"fromCustom","seoDescriptionField":"","seoKeywordsSource":"fromCustom","seoKeywordsField":"","seoImageIds":[],"seoImageSource":"fromAsset","seoImageField":"","seoImageTransform":true,"seoImageTransformMode":"crop","seoImageDescriptionSource":"fromCustom","seoImageDescriptionField":"","twitterCreatorSource":"sameAsSite","twitterCreatorField":"","twitterTitleSource":"sameAsSeo","twitterTitleField":"","twitterSiteNamePositionSource":"sameAsGlobal","twitterDescriptionSource":"sameAsSeo","twitterDescriptionField":"","twitterImageIds":[],"twitterImageSource":"sameAsSeo","twitterImageField":"","twitterImageTransform":true,"twitterImageTransformMode":"crop","twitterImageDescriptionSource":"sameAsSeo","twitterImageDescriptionField":"","ogTitleSource":"sameAsSeo","ogTitleField":"","ogSiteNamePositionSource":"sameAsGlobal","ogDescriptionSource":"sameAsSeo","ogDescriptionField":"","ogImageIds":[],"ogImageSource":"sameAsSeo","ogImageField":"","ogImageTransform":true,"ogImageTransformMode":"crop","ogImageDescriptionSource":"sameAsSeo","ogImageDescriptionField":""}}', NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (14, 9, 1, 'Puppies', '2021-04-01 02:58:45', '2021-04-01 02:58:45', '1a377c71-4884-470c-b966-e4f9c99dcb57', NULL, NULL, NULL, NULL, NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (15, 9, 2, 'Puppies', '2021-04-01 02:58:45', '2021-04-01 02:58:45', 'b49c2cfd-67ba-4927-899e-eb229ed375c1', NULL, NULL, NULL, NULL, NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (16, 10, 1, 'Kitties', '2021-04-01 02:58:52', '2021-04-01 02:58:52', 'e579a89f-d668-4605-9f8c-d77974015b06', NULL, NULL, NULL, NULL, NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (17, 10, 2, 'Kitties', '2021-04-01 02:58:52', '2021-04-01 02:58:52', 'cd6549e2-8d92-4a96-b919-5fe467bf2c3a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (1, 1, 1, 'Homepage', '2021-03-01 00:43:19', '2022-03-17 16:37:48', '40ad16f0-d5c5-4525-823c-87518d9dcb1d', NULL, NULL, NULL, '{"bundleVersion":"1.0.22","sourceBundleType":"field","sourceId":null,"sourceName":null,"sourceHandle":null,"sourceType":"field","typeId":null,"sourceTemplate":"","sourceSiteId":null,"sourceAltSiteSettings":[],"sourceDateUpdated":"2021-03-15T12:31:44-04:00","metaGlobalVars":{"language":null,"mainEntityOfPage":"","seoTitle":"","siteNamePosition":"","seoDescription":"","seoKeywords":"","seoImage":"","seoImageWidth":"","seoImageHeight":"","seoImageDescription":"","canonicalUrl":"","robots":"","ogType":"","ogTitle":"","ogSiteNamePosition":"","ogDescription":"","ogImage":"","ogImageWidth":"","ogImageHeight":"","ogImageDescription":"","twitterCard":"","twitterCreator":"","twitterTitle":"","twitterSiteNamePosition":"","twitterDescription":"","twitterImage":"","twitterImageWidth":"","twitterImageHeight":"","twitterImageDescription":""},"metaSiteVars":{"siteName":"Project","identity":null,"creator":null,"twitterHandle":"","facebookProfileId":"","facebookAppId":"","googleSiteVerification":"","bingSiteVerification":"","pinterestSiteVerification":"","sameAsLinks":[],"siteLinksSearchTarget":"","siteLinksQueryInput":"","referrer":"no-referrer-when-downgrade","additionalSitemapUrls":[],"additionalSitemapUrlsDateUpdated":null,"additionalSitemaps":[]},"metaSitemapVars":{"sitemapUrls":true,"sitemapAssets":true,"sitemapFiles":true,"sitemapAltLinks":true,"sitemapChangeFreq":"weekly","sitemapPriority":0.5,"sitemapLimit":null,"structureDepth":null,"sitemapImageFieldMap":[],"sitemapVideoFieldMap":[]},"metaContainers":{"MetaTagContainergeneral":{"data":[],"name":"General","description":"General Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTagContaineropengraph":{"data":[],"name":"Facebook","description":"Facebook OpenGraph Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"opengraph","include":true,"dependencies":[],"clearCache":false},"MetaTagContainertwitter":{"data":[],"name":"Twitter","description":"Twitter Card Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"twitter","include":true,"dependencies":[],"clearCache":false},"MetaTagContainermiscellaneous":{"data":[],"name":"Miscellaneous","description":"Miscellaneous Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"miscellaneous","include":true,"dependencies":[],"clearCache":false},"MetaLinkContainergeneral":{"data":[],"name":"General","description":"Link Tags","class":"nystudio107\\seomatic\\models\\MetaLinkContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaScriptContainergeneral":{"data":[],"position":1,"name":"General","description":"Script Tags","class":"nystudio107\\seomatic\\models\\MetaScriptContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaJsonLdContainergeneral":{"data":[],"name":"General","description":"JsonLd Tags","class":"nystudio107\\seomatic\\models\\MetaJsonLdContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTitleContainergeneral":{"data":[],"name":"General","description":"Meta Title Tag","class":"nystudio107\\seomatic\\models\\MetaTitleContainer","handle":"general","include":true,"dependencies":[],"clearCache":false}},"redirectsContainer":[],"frontendTemplatesContainer":{"data":[],"name":null,"description":null,"class":"nystudio107\\seomatic\\models\\FrontendTemplateContainer","handle":null,"include":true,"dependencies":null,"clearCache":false},"metaBundleSettings":{"siteType":"","siteSubType":"","siteSpecificType":"","seoTitleSource":"fromCustom","seoTitleField":"","siteNamePositionSource":"sameAsGlobal","seoDescriptionSource":"fromCustom","seoDescriptionField":"","seoKeywordsSource":"fromCustom","seoKeywordsField":"","seoImageIds":[],"seoImageSource":"fromAsset","seoImageField":"","seoImageTransform":true,"seoImageTransformMode":"crop","seoImageDescriptionSource":"fromCustom","seoImageDescriptionField":"","twitterCreatorSource":"sameAsSite","twitterCreatorField":"","twitterTitleSource":"sameAsSeo","twitterTitleField":"","twitterSiteNamePositionSource":"sameAsGlobal","twitterDescriptionSource":"sameAsSeo","twitterDescriptionField":"","twitterImageIds":[],"twitterImageSource":"sameAsSeo","twitterImageField":"","twitterImageTransform":true,"twitterImageTransformMode":"crop","twitterImageDescriptionSource":"sameAsSeo","twitterImageDescriptionField":"","ogTitleSource":"sameAsSeo","ogTitleField":"","ogSiteNamePositionSource":"sameAsGlobal","ogDescriptionSource":"sameAsSeo","ogDescriptionField":"","ogImageIds":[],"ogImageSource":"sameAsSeo","ogImageField":"","ogImageTransform":true,"ogImageTransformMode":"crop","ogImageDescriptionSource":"sameAsSeo","ogImageDescriptionField":""}}', NULL);
INSERT INTO public.content (id, "elementId", "siteId", title, "dateCreated", "dateUpdated", uid, "field_optimizedImages", "field_plainText", "field_richText", field_seo, "field_someImages_hjezvijy") VALUES (5, 1, 2, 'Homepage', '2021-03-15 16:29:22', '2022-03-17 16:37:48', '5ecaa580-ef7a-401c-bdf5-644598247957', NULL, NULL, NULL, '{"bundleVersion":"1.0.22","sourceBundleType":"field","sourceId":null,"sourceName":null,"sourceHandle":null,"sourceType":"field","typeId":null,"sourceTemplate":"","sourceSiteId":null,"sourceAltSiteSettings":[],"sourceDateUpdated":"2021-03-15T12:31:44-04:00","metaGlobalVars":{"language":null,"mainEntityOfPage":"","seoTitle":"","siteNamePosition":"","seoDescription":"","seoKeywords":"","seoImage":"","seoImageWidth":"","seoImageHeight":"","seoImageDescription":"","canonicalUrl":"","robots":"","ogType":"","ogTitle":"","ogSiteNamePosition":"","ogDescription":"","ogImage":"","ogImageWidth":"","ogImageHeight":"","ogImageDescription":"","twitterCard":"","twitterCreator":"","twitterTitle":"","twitterSiteNamePosition":"","twitterDescription":"","twitterImage":"","twitterImageWidth":"","twitterImageHeight":"","twitterImageDescription":""},"metaSiteVars":{"siteName":"Project","identity":null,"creator":null,"twitterHandle":"","facebookProfileId":"","facebookAppId":"","googleSiteVerification":"","bingSiteVerification":"","pinterestSiteVerification":"","sameAsLinks":[],"siteLinksSearchTarget":"","siteLinksQueryInput":"","referrer":"no-referrer-when-downgrade","additionalSitemapUrls":[],"additionalSitemapUrlsDateUpdated":null,"additionalSitemaps":[]},"metaSitemapVars":{"sitemapUrls":true,"sitemapAssets":true,"sitemapFiles":true,"sitemapAltLinks":true,"sitemapChangeFreq":"weekly","sitemapPriority":0.5,"sitemapLimit":null,"structureDepth":null,"sitemapImageFieldMap":[],"sitemapVideoFieldMap":[]},"metaContainers":{"MetaTagContainergeneral":{"data":[],"name":"General","description":"General Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTagContaineropengraph":{"data":[],"name":"Facebook","description":"Facebook OpenGraph Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"opengraph","include":true,"dependencies":[],"clearCache":false},"MetaTagContainertwitter":{"data":[],"name":"Twitter","description":"Twitter Card Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"twitter","include":true,"dependencies":[],"clearCache":false},"MetaTagContainermiscellaneous":{"data":[],"name":"Miscellaneous","description":"Miscellaneous Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"miscellaneous","include":true,"dependencies":[],"clearCache":false},"MetaLinkContainergeneral":{"data":[],"name":"General","description":"Link Tags","class":"nystudio107\\seomatic\\models\\MetaLinkContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaScriptContainergeneral":{"data":[],"position":1,"name":"General","description":"Script Tags","class":"nystudio107\\seomatic\\models\\MetaScriptContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaJsonLdContainergeneral":{"data":[],"name":"General","description":"JsonLd Tags","class":"nystudio107\\seomatic\\models\\MetaJsonLdContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTitleContainergeneral":{"data":[],"name":"General","description":"Meta Title Tag","class":"nystudio107\\seomatic\\models\\MetaTitleContainer","handle":"general","include":true,"dependencies":[],"clearCache":false}},"redirectsContainer":[],"frontendTemplatesContainer":{"data":[],"name":null,"description":null,"class":"nystudio107\\seomatic\\models\\FrontendTemplateContainer","handle":null,"include":true,"dependencies":null,"clearCache":false},"metaBundleSettings":{"siteType":"","siteSubType":"","siteSpecificType":"","seoTitleSource":"fromCustom","seoTitleField":"","siteNamePositionSource":"sameAsGlobal","seoDescriptionSource":"fromCustom","seoDescriptionField":"","seoKeywordsSource":"fromCustom","seoKeywordsField":"","seoImageIds":[],"seoImageSource":"fromAsset","seoImageField":"","seoImageTransform":true,"seoImageTransformMode":"crop","seoImageDescriptionSource":"fromCustom","seoImageDescriptionField":"","twitterCreatorSource":"sameAsSite","twitterCreatorField":"","twitterTitleSource":"sameAsSeo","twitterTitleField":"","twitterSiteNamePositionSource":"sameAsGlobal","twitterDescriptionSource":"sameAsSeo","twitterDescriptionField":"","twitterImageIds":[],"twitterImageSource":"sameAsSeo","twitterImageField":"","twitterImageTransform":true,"twitterImageTransformMode":"crop","twitterImageDescriptionSource":"sameAsSeo","twitterImageDescriptionField":"","ogTitleSource":"sameAsSeo","ogTitleField":"","ogSiteNamePositionSource":"sameAsGlobal","ogDescriptionSource":"sameAsSeo","ogDescriptionField":"","ogImageIds":[],"ogImageSource":"sameAsSeo","ogImageField":"","ogImageTransform":true,"ogImageTransformMode":"crop","ogImageDescriptionSource":"sameAsSeo","ogImageDescriptionField":""}}', NULL);
...
--
-- Data for Name: digitalproducts_licenses; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: digitalproducts_products; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: digitalproducts_producttypes; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: digitalproducts_producttypes_sites; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.elements (id, "draftId", "revisionId", "fieldLayoutId", type, enabled, archived, "dateCreated", "dateUpdated", "dateDeleted", uid, "canonicalId", "dateLastMerged") VALUES (1, NULL, NULL, 3, 'craft\elements\Entry', true, false, '2021-03-01 00:43:19', '2022-03-17 16:37:48', NULL, 'dca9e96d-68d4-41db-8021-100ae78dc231', NULL, NULL);
INSERT INTO public.elements (id, "draftId", "revisionId", "fieldLayoutId", type, enabled, archived, "dateCreated", "dateUpdated", "dateDeleted", uid, "canonicalId", "dateLastMerged") VALUES (4, NULL, NULL, 5, 'craft\elements\GlobalSet', true, false, '2021-03-15 16:25:51', '2022-03-17 16:37:50', NULL, 'aa7c6968-88ec-4d2a-af47-d3c40b582a68', NULL, NULL);
...
INSERT INTO public.entries (id, "sectionId", "parentId", "typeId", "authorId", "postDate", "expiryDate", "deletedWithEntryType", "dateCreated", "dateUpdated", uid) VALUES (6, 3, NULL, 3, 2, '2021-03-15 16:30:00', NULL, NULL, '2021-03-15 16:31:03', '2021-03-15 16:31:03', '08bf17c3-56b1-4f0a-8d2f-9995affebded');
INSERT INTO public.entries (id, "sectionId", "parentId", "typeId", "authorId", "postDate", "expiryDate", "deletedWithEntryType", "dateCreated", "dateUpdated", uid) VALUES (7, 3, NULL, 3, 2, '2021-03-15 16:30:00', NULL, NULL, '2021-03-15 16:31:04', '2021-03-15 16:31:04', '53d12f42-b5cc-43d4-9c63-a1a1dc2a5bb5');
INSERT INTO public.entries (id, "sectionId", "parentId", "typeId", "authorId", "postDate", "expiryDate", "deletedWithEntryType", "dateCreated", "dateUpdated", uid) VALUES (8, 3, NULL, 3, 2, '2021-03-15 16:30:00', NULL, NULL, '2021-03-15 16:32:15', '2021-03-15 16:32:15', 'af541f67-8cd0-4b93-b8a8-181ce19893a5');
...
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (72, 6, 47, 7, false, 1, '2022-03-17 16:37:48', '2022-03-17 16:37:48', 'd1e26179-9a93-4a6b-aa8a-780ef7805226');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (73, 6, 47, 8, false, 2, '2022-03-17 16:37:48', '2022-03-17 16:37:48', '8c24dfb8-a0ea-4a17-b571-be6fa1488573');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (74, 6, 47, 9, false, 3, '2022-03-17 16:37:48', '2022-03-17 16:37:48', '4a2d437f-ab59-4462-986a-a2f81c3a8490');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (75, 3, 48, 7, false, 1, '2022-03-17 16:37:48', '2022-03-17 16:37:48', '6f9b9869-13af-4ac8-a397-10688ddb94f1');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (76, 3, 48, 8, false, 2, '2022-03-17 16:37:48', '2022-03-17 16:37:48', 'ed94e484-18ca-4db8-9b84-32ef400ae00d');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (77, 3, 48, 9, false, 3, '2022-03-17 16:37:48', '2022-03-17 16:37:48', '7a485ade-9054-444a-b23b-94ff23655a0c');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (78, 8, 49, 7, false, 1, '2022-03-17 16:37:48', '2022-03-17 16:37:48', '7167e5fc-3809-4b97-8a95-43ddfea582bd');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (79, 8, 49, 8, false, 2, '2022-03-17 16:37:48', '2022-03-17 16:37:48', '1769a99d-44a9-495b-a623-8e7d381249a4');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (80, 8, 49, 9, false, 3, '2022-03-17 16:37:48', '2022-03-17 16:37:48', '9cd4ad30-0044-4bff-83e5-8ed196ab405d');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (83, 1, 51, 5, false, 1, '2022-03-17 16:37:49', '2022-03-17 16:37:49', 'dde4aaa6-5b5f-42ad-b96e-e6bdb89929f6');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (84, 1, 51, 10, false, 2, '2022-03-17 16:37:49', '2022-03-17 16:37:49', 'a12b87a4-8d94-49c8-844e-284efefb20d5');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (85, 5, 53, 7, false, 0, '2022-03-17 16:37:50', '2022-03-17 16:37:50', 'ccede240-ee05-4aca-89d5-e4393a2f1eec');
INSERT INTO public.fieldlayoutfields (id, "layoutId", "tabId", "fieldId", required, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (86, 5, 53, 8, false, 1, '2022-03-17 16:37:50', '2022-03-17 16:37:50', '4d8efc92-54d4-4a19-a0cf-d45a8293731d');
...
INSERT INTO public.fieldlayouttabs (id, "layoutId", name, elements, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (25, 7, 'Content', '[{"type":"craft\\fieldlayoutelements\\EntryTitleField","autocomplete":false,"class":null,"size":null,"name":null,"autocorrect":true,"autocapitalize":true,"disabled":false,"readonly":false,"title":null,"placeholder":null,"step":null,"min":null,"max":null,"requirable":false,"id":null,"containerAttributes":[],"inputContainerAttributes":[],"labelAttributes":[],"orientation":null,"label":null,"instructions":null,"tip":null,"warning":null,"width":100},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"21903cb2-5b82-49ea-9766-e120d0951ea3"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"abcda4a4-b1db-4677-b5d6-69588443704f"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"4a0cb371-14a6-415d-84db-fc0512410ec8"}]', 1, '2021-04-01 02:48:37', '2021-04-01 02:48:37', '844e3bdd-e8bd-4077-a9b2-e39c1591a2cf');
INSERT INTO public.fieldlayouttabs (id, "layoutId", name, elements, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (45, 4, 'Content', '[{"type":"craft\\commerce\\fieldlayoutelements\\VariantsField","label":null,"instructions":null,"tip":null,"warning":null,"required":false},{"type":"craft\\commerce\\fieldlayoutelements\\ProductTitleField","autocomplete":false,"class":null,"size":null,"name":null,"autocorrect":true,"autocapitalize":true,"disabled":false,"readonly":false,"title":null,"placeholder":null,"step":null,"min":null,"max":null,"requirable":false,"id":null,"containerAttributes":[],"inputContainerAttributes":[],"labelAttributes":[],"orientation":null,"label":null,"instructions":null,"tip":null,"warning":null,"width":100}]', 1, '2022-03-17 16:37:48', '2022-03-17 16:37:48', 'e47c7dc6-c131-4f62-8dc4-95d5734553ac');
INSERT INTO public.fieldlayouttabs (id, "layoutId", name, elements, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (47, 6, 'Content', '[{"type":"craft\\fieldlayoutelements\\EntryTitleField","autocomplete":false,"class":null,"size":null,"name":null,"autocorrect":true,"autocapitalize":true,"disabled":false,"readonly":false,"title":null,"placeholder":null,"step":null,"min":null,"max":null,"requirable":false,"id":null,"containerAttributes":[],"inputContainerAttributes":[],"labelAttributes":[],"orientation":null,"label":null,"instructions":null,"tip":null,"warning":null,"width":100},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"21903cb2-5b82-49ea-9766-e120d0951ea3"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"abcda4a4-b1db-4677-b5d6-69588443704f"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"4a0cb371-14a6-415d-84db-fc0512410ec8"}]', 1, '2022-03-17 16:37:48', '2022-03-17 16:37:48', 'c3f50815-4a42-4e1f-a945-cad01d7dd7e4');
INSERT INTO public.fieldlayouttabs (id, "layoutId", name, elements, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (48, 3, 'Content', '[{"type":"craft\\fieldlayoutelements\\EntryTitleField","autocomplete":false,"class":null,"size":null,"name":null,"autocorrect":true,"autocapitalize":true,"disabled":false,"readonly":false,"title":null,"placeholder":null,"step":null,"min":null,"max":null,"requirable":false,"id":null,"containerAttributes":[],"inputContainerAttributes":[],"labelAttributes":[],"orientation":null,"label":null,"instructions":null,"tip":null,"warning":null,"width":100},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"21903cb2-5b82-49ea-9766-e120d0951ea3"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"abcda4a4-b1db-4677-b5d6-69588443704f"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"4a0cb371-14a6-415d-84db-fc0512410ec8"}]', 1, '2022-03-17 16:37:48', '2022-03-17 16:37:48', '98946c52-a065-48a1-a292-30dddc45804d');
INSERT INTO public.fieldlayouttabs (id, "layoutId", name, elements, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (49, 8, 'Content', '[{"type":"craft\\fieldlayoutelements\\EntryTitleField","autocomplete":false,"class":null,"size":null,"name":null,"autocorrect":true,"autocapitalize":true,"disabled":false,"readonly":false,"title":null,"placeholder":null,"step":null,"min":null,"max":null,"requirable":false,"id":null,"containerAttributes":[],"inputContainerAttributes":[],"labelAttributes":[],"orientation":null,"label":null,"instructions":null,"tip":null,"warning":null,"width":100},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"21903cb2-5b82-49ea-9766-e120d0951ea3"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"abcda4a4-b1db-4677-b5d6-69588443704f"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"4a0cb371-14a6-415d-84db-fc0512410ec8"}]', 1, '2022-03-17 16:37:48', '2022-03-17 16:37:48', 'bf88fc16-31b4-4b9a-81e7-971ba4118dca');
INSERT INTO public.fieldlayouttabs (id, "layoutId", name, elements, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (51, 1, 'Content', '[{"type":"craft\\fieldlayoutelements\\AssetTitleField","autocomplete":false,"class":null,"size":null,"name":null,"autocorrect":true,"autocapitalize":true,"disabled":false,"readonly":false,"title":null,"placeholder":null,"step":null,"min":null,"max":null,"requirable":false,"id":null,"containerAttributes":[],"inputContainerAttributes":[],"labelAttributes":[],"orientation":null,"label":null,"instructions":null,"tip":null,"warning":null,"width":100},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"3fccd13a-e7e7-4d00-8505-0ba4cf0b9be5"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"3ac44e69-f6b1-48f7-a9a6-f4cf14261b16"}]', 1, '2022-03-17 16:37:49', '2022-03-17 16:37:49', '7698d352-7f4f-4bff-b250-726d1a5fd85f');
INSERT INTO public.fieldlayouttabs (id, "layoutId", name, elements, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (52, 9, 'Content', '[{"type":"craft\\fieldlayoutelements\\TitleField","autocomplete":false,"class":null,"size":null,"name":null,"autocorrect":true,"autocapitalize":true,"disabled":false,"readonly":false,"title":null,"placeholder":null,"step":null,"min":null,"max":null,"requirable":false,"id":null,"containerAttributes":[],"inputContainerAttributes":[],"labelAttributes":[],"orientation":null,"label":null,"instructions":null,"tip":null,"warning":null,"width":100}]', 1, '2022-03-17 16:37:50', '2022-03-17 16:37:50', '73ebb120-e924-4ad2-b776-a058196e0ac6');
INSERT INTO public.fieldlayouttabs (id, "layoutId", name, elements, "sortOrder", "dateCreated", "dateUpdated", uid) VALUES (53, 5, 'Default', '[{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"21903cb2-5b82-49ea-9766-e120d0951ea3"},{"type":"craft\\fieldlayoutelements\\CustomField","label":null,"instructions":null,"tip":null,"warning":null,"required":false,"width":100,"fieldUid":"abcda4a4-b1db-4677-b5d6-69588443704f"}]', 1, '2022-03-17 16:37:50', '2022-03-17 16:37:50', 'fefb4a29-a6f2-42d4-a88f-1eb5d8f14cb2');
...
INSERT INTO public.fields (id, "groupId", name, handle, context, instructions, searchable, "translationMethod", "translationKeyFormat", type, settings, "dateCreated", "dateUpdated", uid, "columnSuffix") VALUES (8, 1, 'Rich Text', 'richText', 'global', '', false, 'none', NULL, 'craft\redactor\Field', '{"availableTransforms":"*","availableVolumes":"*","columnType":"text","configSelectionMode":"choose","defaultTransform":"","manualConfig":"","purifierConfig":"","purifyHtml":"1","redactorConfig":"Simple.json","removeEmptyTags":"1","removeInlineStyles":"1","removeNbsp":"1","showHtmlButtonForNonAdmins":"","showUnpermittedFiles":false,"showUnpermittedVolumes":false,"uiMode":"enlarged"}', '2021-03-15 16:25:50', '2022-03-17 16:37:46', 'abcda4a4-b1db-4677-b5d6-69588443704f', NULL);
INSERT INTO public.fields (id, "groupId", name, handle, context, instructions, searchable, "translationMethod", "translationKeyFormat", type, settings, "dateCreated", "dateUpdated", uid, "columnSuffix") VALUES (9, 1, 'SEO', 'seo', 'global', '', false, 'none', NULL, 'nystudio107\seomatic\fields\SeoSettings', '{"elementDisplayPreviewType":"google","facebookTabEnabled":"","generalEnabledFields":["seoPreview","mainEntityOfPage","seoTitle","siteNamePosition","seoDescription","seoKeywords","seoImage","seoImageTransform","seoImageTransformMode","seoImageDescription","robots","canonicalUrl"],"generalTabEnabled":"1","sitemapEnabledFields":["sitemapUrls","sitemapAssets","sitemapFiles","sitemapAltLinks","sitemapChangeFreq","sitemapPriority","sitemapLimit"],"sitemapTabEnabled":"","twitterTabEnabled":""}', '2021-03-15 16:25:50', '2022-03-17 16:37:46', '4a0cb371-14a6-415d-84db-fc0512410ec8', NULL);
INSERT INTO public.fields (id, "groupId", name, handle, context, instructions, searchable, "translationMethod", "translationKeyFormat", type, settings, "dateCreated", "dateUpdated", uid, "columnSuffix") VALUES (10, 1, 'Some Images', 'someImages', 'global', '', false, 'none', NULL, 'nystudio107\imageoptimize\fields\OptimizedImages', '{"displayDominantColorPalette":"1","displayLazyLoadPlaceholderImages":"1","displayOptimizedImageVariants":"1","variants":[{"width":"1200","useAspectRatio":"1","aspectRatioX":"16","aspectRatioY":"9","retinaSizes":["1"],"quality":"82","format":"jpg"},{"width":"992","useAspectRatio":"1","aspectRatioX":"16","aspectRatioY":"9","retinaSizes":["1"],"quality":"82","format":"jpg"},{"width":"768","useAspectRatio":"1","aspectRatioX":"4","aspectRatioY":"3","retinaSizes":["1"],"quality":"60","format":"jpg"},{"width":"576","useAspectRatio":"1","aspectRatioX":"4","aspectRatioY":"3","retinaSizes":["1"],"quality":"60","format":"jpg"}]}', '2022-03-17 16:37:46', '2022-03-17 16:37:46', '3ac44e69-f6b1-48f7-a9a6-f4cf14261b16', 'hjezvijy');
...
INSERT INTO public.globalsets (id, name, handle, "fieldLayoutId", "dateCreated", "dateUpdated", uid, "sortOrder") VALUES (4, 'Globals', 'globals', 5, '2021-03-15 16:25:51', '2022-03-17 16:37:47', 'aa7c6968-88ec-4d2a-af47-d3c40b582a68', 2);
...
INSERT INTO public.info (id, version, "schemaVersion", maintenance, "configVersion", "fieldVersion", "dateCreated", "dateUpdated", uid) VALUES (1, '3.7.37', '3.7.33', false, 'wkbavfftyvhk', '2@esqdmyofzt', '2021-03-01 00:43:17', '2022-03-17 16:37:51', 'b7a12d28-aa59-44af-815b-8cca8a6dcdfb');
...
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (368, 'plugin:calendar', 'Install', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', 'fdfec8dc-e275-4098-b622-e086a79ea251');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (369, 'plugin:calendar', 'm180316_130028_Craft3Upgrade', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2939cd10-2c77-46ad-851b-4016263b9ddd');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (370, 'plugin:calendar', 'm180601_113607_MigrateCalendarEventFieldtype', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '251b1737-a9a2-49bf-a13d-e8872a735fff');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (371, 'plugin:calendar', 'm180619_120655_MigrateCalendarElementsAndLayouts', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '1362427d-72da-47f4-9b99-fb516e2422af');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (372, 'plugin:calendar', 'm180628_091905_MigrateSelectDates', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2771d0fe-55c6-4c39-8a16-ecbbb7dade1a');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (373, 'plugin:calendar', 'm180921_124711_AddIcsTimezoneToCalendar', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '8d72d2f0-aacc-465f-85d2-5a4ff941af68');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (374, 'plugin:calendar', 'm190925_094628_AddAllowRepeatingEventsToCalendar', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', 'dfba1906-19e7-44ea-9dbc-457ed9881154');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (375, 'plugin:calendar', 'm191022_124711_AddMultiSitesFix', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '88e4fdb0-60e9-40eb-a26a-53aff8debf56');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (376, 'plugin:calendar', 'm200608_083342_AddPostDateToEvents', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '68b22e8c-76f7-4f97-9389-2dffe2305825');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (377, 'plugin:calendar', 'm210506_063418_AddProjectConfigSupport', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', 'e59113ad-054e-499c-99ba-07a0d952d165');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (378, 'plugin:calendar', 'm210929_131016_PermissionsMigrationForProjectConfig', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '56be2a0b-a578-4c99-a585-475963f971c5');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (379, 'plugin:calendar', 'm211001_063936_AddPrimaryKeyForEventsTable', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '1e300e3f-006f-4ad7-930d-8b31900fa875');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (380, 'plugin:digital-products', 'Install', '2022-03-17 16:37:36', '2022-03-17 16:37:36', '2022-03-17 16:37:36', '857e2756-3a55-4d19-b676-efa4473afed5');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (381, 'plugin:digital-products', 'm171129_154500_craft3_upgrade', '2022-03-17 16:37:36', '2022-03-17 16:37:36', '2022-03-17 16:37:36', '982a081a-3b86-45d4-a360-803086bbd520');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (382, 'plugin:digital-products', 'm181025_111000_product_types_project_config_support', '2022-03-17 16:37:36', '2022-03-17 16:37:36', '2022-03-17 16:37:36', '7b44c301-37a4-45b4-aa98-efba1a803e98');
INSERT INTO public.migrations (id, track, name, "applyTime", "dateCreated", "dateUpdated", uid) VALUES (383, 'plugin:digital-products', 'm190425_152400_fix_product_edit_permissions', '2022-03-17 16:37:36', '2022-03-17 16:37:36', '2022-03-17 16:37:36', 'c078e8d8-6f9b-457e-b055-9574a8d95987');
...
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (13, 'commerce', '3.4.12', '3.4.12', 'trial', NULL, '2021-03-15 16:25:47', '2021-03-15 16:25:47', '2022-03-17 16:37:24', 'afa2c77c-ac3f-434e-9e1a-ca65743ac078');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (1, 'fastcgi-cache-bust', '1.0.10', '1.0.0', 'unknown', NULL, '2021-03-01 00:43:18', '2021-03-01 00:43:18', '2022-03-17 16:37:24', '7377e77f-3257-49fc-8521-2d4a1fef4cdc');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (2, 'image-optimize', '1.6.43', '1.0.0', 'trial', NULL, '2021-03-01 00:43:18', '2021-03-01 00:43:18', '2022-03-17 16:37:24', '4108ab2f-4fed-493d-98f4-af558f5b8e59');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (11, 'instant-analytics', '1.1.15', '1.0.0', 'trial', NULL, '2021-03-05 16:56:27', '2021-03-05 16:56:27', '2022-03-17 16:37:24', '55f695dc-92f6-4172-9ed4-b0a6b2b54392');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (3, 'minify', '1.2.11', '1.0.0', 'unknown', NULL, '2021-03-01 00:43:18', '2021-03-01 00:43:18', '2022-03-17 16:37:24', '4cbf0518-907e-472a-bee8-819a5738db9d');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (14, 'redactor', '2.10.5', '2.3.0', 'unknown', NULL, '2021-03-15 16:25:49', '2021-03-15 16:25:49', '2022-03-17 16:37:24', 'a572099f-9e17-49ed-94e4-c208acb2f830');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (4, 'retour', '3.1.70', '3.0.10', 'trial', NULL, '2021-03-01 00:43:18', '2021-03-01 00:43:18', '2022-03-17 16:37:24', '826d8fcd-9f23-4182-9a09-4d124b589499');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (15, 'rich-variables', '1.0.31', '1.0.0', 'trial', NULL, '2021-03-15 16:25:49', '2021-03-15 16:25:49', '2022-03-17 16:37:24', '5efbc078-6be4-4428-9ede-0f9ee47de7e3');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (5, 'seomatic', '3.4.28', '3.0.11', 'trial', NULL, '2021-03-01 00:43:18', '2021-03-01 00:43:18', '2022-03-17 16:37:24', '3228a8fc-d00d-4ad8-b21c-b0c7acf23f45');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (6, 'templatecomments', '1.1.2', '1.0.0', 'unknown', NULL, '2021-03-01 00:43:18', '2021-03-01 00:43:18', '2022-03-17 16:37:24', 'df1817b1-3934-46f4-b548-4a1b7f502607');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (16, 'transcoder', '1.2.21', '1.0.0', 'trial', NULL, '2021-03-15 16:25:49', '2021-03-15 16:25:49', '2022-03-17 16:37:24', '3a50879b-1942-4e99-b581-14e87eead04b');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (7, 'twigpack', '1.2.15', '1.0.0', 'unknown', NULL, '2021-03-01 00:43:18', '2021-03-01 00:43:18', '2022-03-17 16:37:24', 'e33ad435-1456-401b-a4a2-3d9168047411');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (8, 'typogrify', '1.1.19', '1.0.0', 'unknown', NULL, '2021-03-01 00:43:18', '2021-03-01 00:43:18', '2022-03-17 16:37:24', '6bc3186c-8e2b-4c21-b565-f67ab970193b');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (9, 'webperf', '1.0.27', '1.0.1', 'trial', NULL, '2021-03-01 00:43:18', '2021-03-01 00:43:18', '2022-03-17 16:37:24', '656aa73d-0e1d-44cc-9227-5b919fadd8c9');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (17, 'calendar', '3.3.9', '3.3.2', 'unknown', NULL, '2022-03-17 16:37:34', '2022-03-17 16:37:34', '2022-03-17 16:37:34', '1f9dd185-6d3e-440b-8469-d3b855b74ed4');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (18, 'connect', '1.0.0', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:35', '2022-03-17 16:37:35', '2022-03-17 16:37:35', '3cbdd8e6-4745-4e4c-9fe0-87ace6b89079');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (19, 'cookies', '1.1.15', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:35', '2022-03-17 16:37:35', '2022-03-17 16:37:35', '344d1ab8-d3f0-4075-9105-bd13c8530892');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (20, 'digital-products', '2.4.3.2', '2.1.0', 'unknown', NULL, '2022-03-17 16:37:36', '2022-03-17 16:37:36', '2022-03-17 16:37:36', 'a9f3219e-df34-4d55-aff5-ab8753505cf7');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (21, 'disqus', '1.1.3', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:37', '2022-03-17 16:37:37', '2022-03-17 16:37:37', '4054f347-7a8d-4d0b-a62c-7081f094617b');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (22, 'eager-beaver', '1.0.4', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:38', '2022-03-17 16:37:38', '2022-03-17 16:37:38', '01668a99-220d-4124-aa83-a5bfb9a7f10a');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (23, 'empty-coalesce', '1.0.6', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:38', '2022-03-17 16:37:38', '2022-03-17 16:37:38', '9f68d0bb-dde7-4329-be64-d5bfb3dd8eb6');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (24, 'icalendar', '1.1.2', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:39', '2022-03-17 16:37:39', '2022-03-17 16:37:39', '6da863e7-7dd9-4b5f-8e68-d4ae3a5596b7');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (25, 'path-tools', '1.0.7', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:40', '2022-03-17 16:37:40', '2022-03-17 16:37:40', '3225a358-a63c-401a-8b56-425ba523dcee');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (26, 'recipe', '1.4.0', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:40', '2022-03-17 16:37:40', '2022-03-17 16:37:40', '6dc8cf49-9198-4a35-ac72-63e603bc720e');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (27, 'route-map', '1.1.7', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:41', '2022-03-17 16:37:41', '2022-03-17 16:37:41', 'dcb07ae7-ddb9-4a0f-ae8f-3e99b36d7772');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (28, 'similar', '1.1.5', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:41', '2022-03-17 16:37:41', '2022-03-17 16:37:41', '628c8d4b-7e53-4e91-8f3f-af688dafa885');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (29, 'twig-profiler', '1.0.1', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:42', '2022-03-17 16:37:42', '2022-03-17 16:37:42', '920ffa87-403d-45a8-8b68-d7e07f75d959');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (30, 'units', '1.0.4', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:43', '2022-03-17 16:37:43', '2022-03-17 16:37:43', '0ccc29d4-cea9-4d79-9f97-99f8f9cbe90f');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (31, 'vanillaforums', '3.0.1', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:43', '2022-03-17 16:37:43', '2022-03-17 16:37:43', '85cd040d-abad-4169-bf96-73bc43575132');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (32, 'vite', '1.0.23', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:44', '2022-03-17 16:37:44', '2022-03-17 16:37:44', '107d438a-cb19-4d72-87e6-1b315a661839');
INSERT INTO public.plugins (id, handle, version, "schemaVersion", "licenseKeyStatus", "licensedEdition", "installDate", "dateCreated", "dateUpdated", uid) VALUES (33, 'youtubeliveembed', '1.0.2', '1.0.0', 'unknown', NULL, '2022-03-17 16:37:44', '2022-03-17 16:37:44', '2022-03-17 16:37:44', '488b13c7-f84d-4d56-8244-e015295aae68');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.icalendar.enabled', 'true');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.icalendar.schemaVersion', '"1.0.0"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.path-tools.edition', '"standard"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.path-tools.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.path-tools.schemaVersion', '"1.0.0"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.commerce.schemaVersion', '"3.4.12"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.schemaVersion', '"3.0.10"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.seomatic.schemaVersion', '"3.0.11"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('dateModified', '1647534631');
...
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.0.required', 'false');
...
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.0.type', '"craft\\commerce\\fieldlayoutelements\\VariantsField"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.autocapitalize', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.autocomplete', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.autocorrect', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.class', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.disabled', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.id', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.instructions', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.label', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.max', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.min', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.name', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.orientation', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.placeholder', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.readonly', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.requirable', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.size', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.step', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.tip', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.title', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.type', '"craft\\commerce\\fieldlayoutelements\\ProductTitleField"');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.warning', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.productTypes.407fe253-2ada-4a88-b1a4-fb6c2004cd9b.productFieldLayouts.08766548-0b7c-493b-bdce-20f096719426.tabs.0.elements.1.width', '100');
INSERT INTO public.projectconfig (path, value) VALUES ('volumes.5c642d7e-b16b-4836-9575-668d75d242e5.fieldLayouts.e73b4186-2fad-4c0f-8eae-bbb884932c58.tabs.0.elements.2.fieldUid', '"3ac44e69-f6b1-48f7-a9a6-f4cf14261b16"');
INSERT INTO public.projectconfig (path, value) VALUES ('volumes.5c642d7e-b16b-4836-9575-668d75d242e5.fieldLayouts.e73b4186-2fad-4c0f-8eae-bbb884932c58.tabs.0.elements.2.instructions', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('volumes.5c642d7e-b16b-4836-9575-668d75d242e5.fieldLayouts.e73b4186-2fad-4c0f-8eae-bbb884932c58.tabs.0.elements.2.label', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('volumes.5c642d7e-b16b-4836-9575-668d75d242e5.fieldLayouts.e73b4186-2fad-4c0f-8eae-bbb884932c58.tabs.0.elements.2.required', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('volumes.5c642d7e-b16b-4836-9575-668d75d242e5.fieldLayouts.e73b4186-2fad-4c0f-8eae-bbb884932c58.tabs.0.elements.2.tip', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('volumes.5c642d7e-b16b-4836-9575-668d75d242e5.fieldLayouts.e73b4186-2fad-4c0f-8eae-bbb884932c58.tabs.0.elements.2.type', '"craft\\fieldlayoutelements\\CustomField"');
INSERT INTO public.projectconfig (path, value) VALUES ('volumes.5c642d7e-b16b-4836-9575-668d75d242e5.fieldLayouts.e73b4186-2fad-4c0f-8eae-bbb884932c58.tabs.0.elements.2.warning', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('volumes.5c642d7e-b16b-4836-9575-668d75d242e5.fieldLayouts.e73b4186-2fad-4c0f-8eae-bbb884932c58.tabs.0.elements.2.width', '100');
...
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.allowRepeatingEvents', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.color', '"#9E31C4"');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.description', '"The default calendar"');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.descriptionFieldHandle', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.fieldLayout', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.handle', '"default"');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.hasTitleField', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.icsHash', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.icsTimezone', '"floating"');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.locationFieldHandle', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.name', '"Default"');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.815c4fd2-6502-4d25-8605-4d74668e8b0d.enabledByDefault', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.815c4fd2-6502-4d25-8605-4d74668e8b0d.hasUrls', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.815c4fd2-6502-4d25-8605-4d74668e8b0d.siteId', '"ec473f07-152f-423b-90df-ac425e6068a1"');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.815c4fd2-6502-4d25-8605-4d74668e8b0d.template', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.815c4fd2-6502-4d25-8605-4d74668e8b0d.uriFormat', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.aae92448-744c-47d9-9847-843c19e64d1b.enabledByDefault', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.aae92448-744c-47d9-9847-843c19e64d1b.hasUrls', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.aae92448-744c-47d9-9847-843c19e64d1b.siteId', '"5da841b1-ca0d-46ff-8bb1-04d6c889ac54"');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.aae92448-744c-47d9-9847-843c19e64d1b.template', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.siteSettings.aae92448-744c-47d9-9847-843c19e64d1b.uriFormat', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.titleFormat', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('solspace.calendar.calendars.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598.titleLabel', '"Title"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('commerce.gateways.6a117ef0-054c-4147-acb6-6fe57d48c4ae.settings', 'null');
...
INSERT INTO public.projectconfig (path, value) VALUES ('formie.statuses.110568c4-6978-4a9d-ae96-44c45c0739c1.color', '"green"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.statuses.110568c4-6978-4a9d-ae96-44c45c0739c1.description', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.statuses.110568c4-6978-4a9d-ae96-44c45c0739c1.handle', '"new"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.statuses.110568c4-6978-4a9d-ae96-44c45c0739c1.isDefault', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.statuses.110568c4-6978-4a9d-ae96-44c45c0739c1.name', '"New"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.statuses.110568c4-6978-4a9d-ae96-44c45c0739c1.sortOrder', '1');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.availability', '"always"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.availabilityFrom', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.availabilitySubmissions', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.availabilityTo', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.dataRetention', '"forever"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.dataRetentionValue', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.fileUploadsAction', '"retain"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.attachFiles', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.content', '"[{\"type\":\"paragraph\",\"content\":[{\"type\":\"text\",\"text\":\"A user submission has been made on the \\\"\"},{\"type\":\"variableTag\",\"attrs\":{\"label\":\"Form Name\",\"value\":\"{formName}\"}},{\"type\":\"text\",\"text\":\"\\\" form on \"},{\"type\":\"variableTag\",\"attrs\":{\"label\":\"Site Name\",\"value\":\"{siteName}\"}},{\"type\":\"text\",\"text\":\" at \"},{\"type\":\"variableTag\",\"attrs\":{\"label\":\"Timestamp (yyyy-mm-dd hh:mm:ss)\",\"value\":\"{timestamp}\"}}]},{\"type\":\"paragraph\",\"content\":[{\"type\":\"text\",\"text\":\"Their submission details are:\"}]},{\"type\":\"paragraph\",\"content\":[{\"type\":\"variableTag\",\"attrs\":{\"label\":\"All Form Fields\",\"value\":\"{allFields}\"}}]}]"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.from', '"{field.emailAddress}"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.id', '"new981-8077"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.name', '"Admin Notification"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.replyTo', '"{field.emailAddress}"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.subject', '"A new submission was made on \"{formName}\""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.templateId', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.0.to', '"{systemEmail}"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.1.attachFiles', 'true');
...
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.1.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.1.id', '"new7052-5168"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.1.name', '"User Notification"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.1.subject', '"Thanks for contacting us!"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.1.templateId', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.notifications.1.to', '"{field.emailAddress}"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.id', '"new1272610411"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.label', '"Page 1"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.brandNewField', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.columnWidth', '12');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.handle', '"yourName"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.hasLabel', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.id', '"new7715-7348"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.label', '"Your Name"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.firstNameCollapsed', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.firstNameDefaultValue', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.firstNameEnabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.firstNameLabel', '"First Name"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.firstNamePlaceholder', '"e.g. Peter"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.firstNameRequired', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.handle', '"yourName"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.instructions', '"Please enter your full name."');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.instructionsPosition', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.label', '"Your Name"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.labelPosition', '"verbb\\formie\\positions\\Hidden"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.lastNameCollapsed', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.lastNameDefaultValue', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.lastNameEnabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.lastNameLabel', '"Last Name"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.lastNamePlaceholder', '"e.g. Sherman"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.lastNameRequired', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.limitType', '"characters"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.middleNameCollapsed', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.middleNameDefaultValue', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.middleNameEnabled', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.middleNameLabel', '"Middle Name"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.placeholder', '"Your name"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.prefixCollapsed', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.prefixDefaultValue', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.prefixEnabled', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.prefixLabel', '"Prefix"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.subfieldLabelPosition', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.settings.useMultipleFields', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.fields.0.type', '"verbb\\formie\\fields\\formfields\\Name"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.0.id', '"new8990-9934"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.brandNewField', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.columnWidth', '12');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.handle', '"emailAddress"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.hasLabel', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.id', '"new6482-9528"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.label', '"Email Address"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.settings.handle', '"emailAddress"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.settings.instructions', '"Please enter your email so we can get in touch."');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.settings.instructionsPosition', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.settings.label', '"Email Address"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.settings.labelPosition', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.settings.limitType', '"characters"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.settings.placeholder', '"e.g. psherman@wallaby.com"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.settings.required', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.fields.0.type', '"verbb\\formie\\fields\\formfields\\Email"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.1.id', '"new9524-8509"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.brandNewField', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.columnWidth', '12');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.handle', '"message"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.hasLabel', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.id', '"new982-7322"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.label', '"Message"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.settings.handle', '"message"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.settings.instructions', '"Please enter your comments."');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.settings.instructionsPosition', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.settings.label', '"Message"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.settings.labelPosition', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.settings.limitType', '"characters"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.settings.placeholder', '"e.g. The reason for my enquiry is..."');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.settings.required', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.fields.0.type', '"verbb\\formie\\fields\\formfields\\MultiLineText"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.rows.2.id', '"new2177-9685"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.settings.backButtonLabel', '"Back"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.settings.buttonsPosition', '"left"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.settings.label', '"Page 1"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.settings.showBackButton', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.settings.submitButtonLabel', '"Contact us"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.pages.0.sortOrder', '0');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.requireUser', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.availabilityMessage', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.availabilityMessageDate', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.availabilityMessageSubmissions', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.collectIp', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.collectUser', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.dataRetention', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.dataRetentionValue', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.defaultEmailTemplateId', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.defaultInstructionsPosition', '"verbb\\formie\\positions\\AboveInput"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.defaultLabelPosition', '"verbb\\formie\\positions\\AboveInput"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.displayCurrentPageTitle', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.displayFormTitle', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.displayPageProgress', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.displayPageTabs', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.errorMessage.0.content.0.text', '"Couldn’t save submission due to errors."');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.errorMessage.0.content.0.type', '"text"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.errorMessage.0.type', '"paragraph"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.errorMessagePosition', '"top-form"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.fileUploadsAction', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.loadingIndicator', '"spinner"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.loadingIndicatorText', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.progressPosition', '"end"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.redirectUrl', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.storeData', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submissionTitleFormat', '"{timestamp}"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitAction', '"message"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitActionFormHide', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitActionMessage.0.content.0.text', '"Thank you for contacting us! Our team will get in touch shortly to follow up on your message."');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitActionMessage.0.content.0.type', '"text"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitActionMessage.0.type', '"paragraph"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitActionMessagePosition', '"top-form"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitActionMessageTimeout', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitActionTab', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitActionUrl', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.submitMethod', '"ajax"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.userDeletedAction', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.validationOnFocus', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.settings.validationOnSubmit', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.data.userDeletedAction', '"retain"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.defaultStatusId', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.handle', '"contactForm"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.name', '"Contact Form"');
INSERT INTO public.projectconfig (path, value) VALUES ('formie.stencils.a0587a0b-d71c-4085-9c28-f0165af2b925.templateId', 'null');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.image-optimize.settings.createPlaceholderSilhouettes', 'true');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.image-optimize.settings.imageTransformTypeSettings.__assoc__.0.1.__assoc__.3.0', '"unsharpMask"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.image-optimize.settings.imageTransformTypeSettings.__assoc__.0.1.__assoc__.3.1', '"20"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.image-optimize.settings.imageTransformTypeSettings.__assoc__.1.1.__assoc__.0.1', '""');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.image-optimize.settings.lowerQualityRetinaImageVariants', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.image-optimize.settings.sharpenScaledImagePercentage', '50');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.additionalHeaders', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.alwaysStripQueryString', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.automaticallyTrimStatistics', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.createUriChangeRedirects', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.dynamicRedirectDisplayLimit', '100');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.enableApiEndpoint', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.excludePatterns', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.pluginName', '"Retour"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.preserveQueryString', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.recordRemoteIp', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.refreshIntervalSecs', '5');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.staticRedirectDisplayLimit', '100');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.statisticsRateLimitMs', '"3600000"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.statsDisplayLimit', '1000');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.statsStoredLimit', '1000');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.stripQueryStringFromStats', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.retour.settings.uriChangeRedirectSrcMatch', '"pathonly"');
INSERT INTO public.projectconfig (path, value) VALUES ('categoryGroups.b8fd3909-9af1-42c4-8c5e-2716a2a1957e.defaultPlacement', '"end"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.icalendar.edition', '"standard"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3fccd13a-e7e7-4d00-8505-0ba4cf0b9be5.columnSuffix', 'null');
...
INSERT INTO public.projectconfig (path, value) VALUES ('fields.21903cb2-5b82-49ea-9766-e120d0951ea3.columnSuffix', 'null');
...
INSERT INTO public.projectconfig (path, value) VALUES ('fields.abcda4a4-b1db-4677-b5d6-69588443704f.columnSuffix', 'null');
...
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.columnSuffix', 'null');
...
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.0', '"seoPreview"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.1', '"mainEntityOfPage"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.2', '"seoTitle"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.3', '"siteNamePosition"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.4', '"seoDescription"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.5', '"seoKeywords"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.6', '"seoImage"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.7', '"seoImageTransform"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.8', '"seoImageTransformMode"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.9', '"seoImageDescription"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.10', '"robots"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.generalEnabledFields.11', '"canonicalUrl"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.sitemapEnabledFields.0', '"sitemapUrls"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.sitemapEnabledFields.1', '"sitemapAssets"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.sitemapEnabledFields.2', '"sitemapFiles"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.sitemapEnabledFields.3', '"sitemapAltLinks"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.sitemapEnabledFields.4', '"sitemapChangeFreq"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.sitemapEnabledFields.5', '"sitemapPriority"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.4a0cb371-14a6-415d-84db-fc0512410ec8.settings.sitemapEnabledFields.6', '"sitemapLimit"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.columnSuffix', '"hjezvijy"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.contentColumnType', '"text"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.fieldGroup', '"94b4d5ac-d7ea-4241-a6cb-92b39f482f99"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.handle', '"someImages"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.instructions', '""');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.name', '"Some Images"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.searchable', 'false');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.displayDominantColorPalette', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.displayLazyLoadPlaceholderImages', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.displayOptimizedImageVariants', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.0.0', '"width"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.0.1', '"1200"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.1.0', '"useAspectRatio"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.1.1', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.2.0', '"aspectRatioX"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.2.1', '"16"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.3.0', '"aspectRatioY"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.3.1', '"9"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.4.0', '"retinaSizes"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.4.1.0', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.5.0', '"quality"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.5.1', '"82"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.6.0', '"format"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.0.__assoc__.6.1', '"jpg"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.0.0', '"width"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.0.1', '"992"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.1.0', '"useAspectRatio"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.1.1', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.2.0', '"aspectRatioX"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.2.1', '"16"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.3.0', '"aspectRatioY"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.3.1', '"9"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.4.0', '"retinaSizes"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.4.1.0', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.5.0', '"quality"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.5.1', '"82"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.6.0', '"format"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.1.__assoc__.6.1', '"jpg"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.0.0', '"width"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.0.1', '"768"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.1.0', '"useAspectRatio"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.1.1', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.2.0', '"aspectRatioX"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.2.1', '"4"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.3.0', '"aspectRatioY"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.3.1', '"3"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.4.0', '"retinaSizes"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.4.1.0', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.5.0', '"quality"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.5.1', '"60"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.6.0', '"format"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.2.__assoc__.6.1', '"jpg"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.0.0', '"width"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.0.1', '"576"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.1.0', '"useAspectRatio"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.1.1', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.2.0', '"aspectRatioX"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.2.1', '"4"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.3.0', '"aspectRatioY"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.3.1', '"3"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.4.0', '"retinaSizes"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.4.1.0', '"1"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.5.0', '"quality"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.5.1', '"60"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.6.0', '"format"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.settings.variants.3.__assoc__.6.1', '"jpg"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.translationKeyFormat', 'null');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.translationMethod', '"none"');
INSERT INTO public.projectconfig (path, value) VALUES ('fields.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16.type', '"nystudio107\\imageoptimize\\fields\\OptimizedImages"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('globalSets.aa7c6968-88ec-4d2a-af47-d3c40b582a68.sortOrder', '2');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.3ac44e69-f6b1-48f7-a9a6-f4cf14261b16', '"Some Images"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.3fccd13a-e7e7-4d00-8505-0ba4cf0b9be5', '"Optimized Images"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.4a0cb371-14a6-415d-84db-fc0512410ec8', '"SEO"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.5c642d7e-b16b-4836-9575-668d75d242e5', '"Site"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.5da841b1-ca0d-46ff-8bb1-04d6c889ac54', '"English"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.6a117ef0-054c-4147-acb6-6fe57d48c4ae', '"Dummy"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.54e60257-f31a-44aa-960e-bbd364197e28', '"Homepage"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.94b4d5ac-d7ea-4241-a6cb-92b39f482f99', '"Common"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.407fe253-2ada-4a88-b1a4-fb6c2004cd9b', '"Clothing"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.550b07f1-ec7b-4dfa-8dd6-373f9f2b6598', '"Default"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.626b0987-e067-4dd2-9918-1d209373265a', '"Review"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.6005c2f9-5d85-4442-b712-22e070096ac8', '"Public Schema"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.21903cb2-5b82-49ea-9766-e120d0951ea3', '"Plain Text"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.110568c4-6978-4a9d-ae96-44c45c0739c1', '"New"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.a0587a0b-d71c-4085-9c28-f0165af2b925', '"Contact Form"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.aa7c6968-88ec-4d2a-af47-d3c40b582a68', '"Globals"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.abcda4a4-b1db-4677-b5d6-69588443704f', '"Rich Text"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.b8fd3909-9af1-42c4-8c5e-2716a2a1957e', '"Category"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.c4536798-743d-4bf0-9669-192827bfb26c', '"Blog"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.de308a7d-1794-448f-9176-29e2eace7ecf', '"Blog"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.ec473f07-152f-423b-90df-ac425e6068a1', '"Spanish"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.f89601e9-4ba9-4a48-9e99-350aa9914912', '"plugindev"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.f923795f-139e-4b59-b27c-eaa0be4f847c', '"New"');
INSERT INTO public.projectconfig (path, value) VALUES ('meta.__names__.fb3a8f31-d1cc-4c13-903b-a501f7e51f54', '"Homepage"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.calendar.edition', '"lite"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.calendar.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.calendar.licenseKey', '"EUPZ9IW6YJVW049EJSQW6K4V"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.calendar.schemaVersion', '"3.3.2"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.connect.edition', '"standard"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.connect.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.connect.schemaVersion', '"1.0.0"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.digital-products.edition', '"standard"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.digital-products.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.digital-products.schemaVersion', '"2.1.0"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.disqus.edition', '"standard"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.disqus.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.disqus.schemaVersion', '"1.0.0"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.units.edition', '"standard"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.units.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.units.schemaVersion', '"1.0.0"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.vanillaforums.edition', '"standard"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.vanillaforums.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.vanillaforums.schemaVersion', '"1.0.0"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.youtubeliveembed.edition', '"standard"');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.youtubeliveembed.enabled', 'true');
INSERT INTO public.projectconfig (path, value) VALUES ('plugins.youtubeliveembed.schemaVersion', '"1.0.0"');
INSERT INTO public.projectconfig (path, value) VALUES ('sections.de308a7d-1794-448f-9176-29e2eace7ecf.defaultPlacement', '"end"');
...
INSERT INTO public.projectconfig (path, value) VALUES ('sections.54e60257-f31a-44aa-960e-bbd364197e28.defaultPlacement', '"end"');
...
INSERT INTO public.revisions (id, "sourceId", "creatorId", num, notes) VALUES (1, 6, 2, 1, '');
INSERT INTO public.revisions (id, "sourceId", "creatorId", num, notes) VALUES (2, 6, 2, 2, '');
...
INSERT INTO public.seomatic_metabundles (id, "dateCreated", "dateUpdated", uid, "bundleVersion", "sourceBundleType", "sourceId", "sourceName", "sourceHandle", "sourceType", "typeId", "sourceTemplate", "sourceSiteId", "sourceAltSiteSettings", "sourceDateUpdated", "metaGlobalVars", "metaSiteVars", "metaSitemapVars", "metaContainers", "redirectsContainer", "frontendTemplatesContainer", "metaBundleSettings") VALUES (8, '2021-04-01 02:58:32', '2022-03-17 16:37:45', 'de012795-cdf4-4aa4-89d2-7d6df4d4cfb0', '1.0.26', 'categorygroup', 1, 'Category', 'category', 'category', NULL, '', 1, '{"1":{"id":1,"groupId":1,"siteId":1,"hasUrls":true,"uriFormat":"category/{slug}","template":null,"language":"en-us"},"2":{"id":2,"groupId":1,"siteId":2,"hasUrls":true,"uriFormat":"category/{slug}","template":null,"language":"es"}}', '2021-04-01 02:58:52', '{"language":null,"mainEntityOfPage":"WebPage","seoTitle":"{category.title}","siteNamePosition":"","seoDescription":"","seoKeywords":"","seoImage":"","seoImageWidth":"","seoImageHeight":"","seoImageDescription":"","canonicalUrl":"{category.url}","robots":"all","ogType":"website","ogTitle":"{seomatic.meta.seoTitle}","ogSiteNamePosition":"","ogDescription":"{seomatic.meta.seoDescription}","ogImage":"{seomatic.meta.seoImage}","ogImageWidth":"{seomatic.meta.seoImageWidth}","ogImageHeight":"{seomatic.meta.seoImageHeight}","ogImageDescription":"{seomatic.meta.seoImageDescription}","twitterCard":"summary_large_image","twitterCreator":"{seomatic.site.twitterHandle}","twitterTitle":"{seomatic.meta.seoTitle}","twitterSiteNamePosition":"","twitterDescription":"{seomatic.meta.seoDescription}","twitterImage":"{seomatic.meta.seoImage}","twitterImageWidth":"{seomatic.meta.seoImageWidth}","twitterImageHeight":"{seomatic.meta.seoImageHeight}","twitterImageDescription":"{seomatic.meta.seoImageDescription}","inherited":[],"overrides":[]}', '{"siteName":"plugindev","identity":null,"creator":null,"twitterHandle":"","facebookProfileId":"","facebookAppId":"","googleSiteVerification":"","bingSiteVerification":"","pinterestSiteVerification":"","facebookSiteVerification":"","sameAsLinks":[],"siteLinksSearchTarget":"","siteLinksQueryInput":"","referrer":"no-referrer-when-downgrade","additionalSitemapUrls":[],"additionalSitemapUrlsDateUpdated":null,"additionalSitemaps":[]}', '{"sitemapUrls":true,"sitemapAssets":true,"sitemapFiles":true,"sitemapAltLinks":true,"sitemapChangeFreq":"weekly","sitemapPriority":0.5,"sitemapLimit":null,"structureDepth":null,"sitemapImageFieldMap":[{"property":"title","field":"title"},{"property":"caption","field":""},{"property":"geo_location","field":""},{"property":"license","field":""}],"sitemapVideoFieldMap":[{"property":"title","field":"title"},{"property":"description","field":""},{"property":"thumbnailLoc","field":""},{"property":"duration","field":""},{"property":"category","field":""}],"inherited":[],"overrides":[]}', '{"MetaTagContainergeneral":{"data":[],"name":"General","description":"General Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTagContaineropengraph":{"data":[],"name":"Facebook","description":"Facebook OpenGraph Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"opengraph","include":true,"dependencies":[],"clearCache":false},"MetaTagContainertwitter":{"data":[],"name":"Twitter","description":"Twitter Card Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"twitter","include":true,"dependencies":[],"clearCache":false},"MetaTagContainermiscellaneous":{"data":[],"name":"Miscellaneous","description":"Miscellaneous Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"miscellaneous","include":true,"dependencies":[],"clearCache":false},"MetaLinkContainergeneral":{"data":[],"name":"General","description":"Link Tags","class":"nystudio107\\seomatic\\models\\MetaLinkContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaScriptContainergeneral":{"data":[],"position":1,"name":"General","description":"Script Tags","class":"nystudio107\\seomatic\\models\\MetaScriptContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaJsonLdContainergeneral":{"data":{"mainEntityOfPage":{"breadcrumb":null,"lastReviewed":null,"mainContentOfPage":null,"primaryImageOfPage":null,"relatedLink":null,"reviewedBy":null,"significantLink":null,"speakable":null,"specialty":null,"about":null,"abstract":null,"accessMode":null,"accessModeSufficient":null,"accessibilityAPI":null,"accessibilityControl":null,"accessibilityFeature":null,"accessibilityHazard":null,"accessibilitySummary":null,"accountablePerson":null,"acquireLicensePage":null,"aggregateRating":null,"alternativeHeadline":null,"associatedMedia":null,"audience":null,"audio":null,"author":{"id":"{parseEnv(seomatic.site.identity.genericUrl)}#identity"},"award":null,"character":null,"citation":null,"comment":null,"commentCount":null,"conditionsOfAccess":null,"contentLocation":null,"contentRating":null,"contentReferenceTime":null,"contributor":null,"copyrightHolder":{"id":"{parseEnv(seomatic.site.identity.genericUrl)}#identity"},"copyrightYear":"{category.dateCreated |date(\"Y\")}","correction":null,"creativeWorkStatus":null,"creator":{"id":"{parseEnv(seomatic.site.identity.genericUrl)}#creator"},"dateCreated":false,"dateModified":"{category.dateUpdated |atom}","datePublished":"{category.dateCreated |atom}","discussionUrl":null,"editor":null,"educationalAlignment":null,"educationalUse":null,"encoding":null,"encodingFormat":null,"exampleOfWork":null,"expires":null,"funder":null,"genre":null,"hasPart":null,"headline":"{seomatic.meta.seoTitle}","inLanguage":"{seomatic.meta.language}","interactionStatistic":null,"interactivityType":null,"isAccessibleForFree":null,"isBasedOn":null,"isFamilyFriendly":null,"isPartOf":null,"keywords":null,"learningResourceType":null,"license":null,"locationCreated":null,"mainEntity":null,"maintainer":null,"material":null,"materialExtent":null,"mentions":null,"offers":null,"position":null,"producer":null,"provider":null,"publication":null,"publisher":{"id":"{parseEnv(seomatic.site.identity.genericUrl)}#creator"},"publisherImprint":null,"publishingPrinciples":null,"recordedAt":null,"releasedEvent":null,"review":null,"schemaVersion":null,"sdDatePublished":null,"sdLicense":null,"sdPublisher":null,"sourceOrganization":null,"spatial":null,"spatialCoverage":null,"sponsor":null,"temporal":null,"temporalCoverage":null,"text":null,"thumbnailUrl":null,"timeRequired":null,"translationOfWork":null,"translator":null,"typicalAgeRange":null,"usageInfo":null,"version":null,"video":null,"workExample":null,"workTranslation":null,"additionalType":null,"alternateName":null,"description":"{seomatic.meta.seoDescription}","disambiguatingDescription":null,"identifier":null,"image":{"type":"ImageObject","url":"{seomatic.meta.seoImage}"},"mainEntityOfPage":"{seomatic.meta.canonicalUrl}","name":"{seomatic.meta.seoTitle}","potentialAction":{"type":"SearchAction","target":"{seomatic.site.siteLinksSearchTarget}","query-input":"{seomatic.helper.siteLinksQueryInput()}"},"sameAs":null,"subjectOf":null,"url":"{seomatic.meta.canonicalUrl}","context":"http://schema.org","type":"{seomatic.meta.mainEntityOfPage}","id":null,"graph":null,"include":true,"key":"mainEntityOfPage","environment":null,"dependencies":null,"tagAttrs":[],"nonce":null}},"name":"General","description":"JsonLd Tags","class":"nystudio107\\seomatic\\models\\MetaJsonLdContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTitleContainergeneral":{"data":{"title":{"title":"{seomatic.meta.seoTitle}","siteName":"{seomatic.site.siteName}","siteNamePosition":"{seomatic.meta.siteNamePosition}","separatorChar":"{seomatic.config.separatorChar}","include":true,"key":"title","environment":null,"dependencies":null,"tagAttrs":[]}},"name":"General","description":"Meta Title Tag","class":"nystudio107\\seomatic\\models\\MetaTitleContainer","handle":"general","include":true,"dependencies":[],"clearCache":false}}', '[]', '{"data":[],"name":null,"description":null,"class":"nystudio107\\seomatic\\models\\FrontendTemplateContainer","handle":null,"include":true,"dependencies":null,"clearCache":false}', '{"siteType":"CreativeWork","siteSubType":"WebPage","siteSpecificType":"","seoTitleSource":"fromField","seoTitleField":"title","siteNamePositionSource":"sameAsGlobal","seoDescriptionSource":"fromCustom","seoDescriptionField":"","seoKeywordsSource":"fromCustom","seoKeywordsField":"","seoImageIds":[],"seoImageSource":"fromAsset","seoImageField":"","seoImageTransform":true,"seoImageTransformMode":"crop","seoImageDescriptionSource":"fromCustom","seoImageDescriptionField":"","twitterCreatorSource":"sameAsSite","twitterCreatorField":"","twitterTitleSource":"sameAsSeo","twitterTitleField":"","twitterSiteNamePositionSource":"sameAsGlobal","twitterDescriptionSource":"sameAsSeo","twitterDescriptionField":"","twitterImageIds":[],"twitterImageSource":"sameAsSeo","twitterImageField":"","twitterImageTransform":true,"twitterImageTransformMode":"crop","twitterImageDescriptionSource":"sameAsSeo","twitterImageDescriptionField":"","ogTitleSource":"sameAsSeo","ogTitleField":"","ogSiteNamePositionSource":"sameAsGlobal","ogDescriptionSource":"sameAsSeo","ogDescriptionField":"","ogImageIds":[],"ogImageSource":"sameAsSeo","ogImageField":"","ogImageTransform":true,"ogImageTransformMode":"crop","ogImageDescriptionSource":"sameAsSeo","ogImageDescriptionField":""}');
INSERT INTO public.seomatic_metabundles (id, "dateCreated", "dateUpdated", uid, "bundleVersion", "sourceBundleType", "sourceId", "sourceName", "sourceHandle", "sourceType", "typeId", "sourceTemplate", "sourceSiteId", "sourceAltSiteSettings", "sourceDateUpdated", "metaGlobalVars", "metaSiteVars", "metaSitemapVars", "metaContainers", "redirectsContainer", "frontendTemplatesContainer", "metaBundleSettings") VALUES (6, '2021-03-15 16:25:51', '2022-03-17 16:37:45', 'd9e84964-aaca-4abd-9ce1-b916b6e27380', '1.0.29', 'section', 3, 'Blog', 'blog', 'channel', NULL, 'blog/_entry', 1, '{"1":{"id":4,"sectionId":3,"siteId":1,"enabledByDefault":true,"hasUrls":true,"uriFormat":"blog/{slug}","template":"blog/_entry","language":"en-us"},"2":{"id":5,"sectionId":3,"siteId":2,"enabledByDefault":true,"hasUrls":true,"uriFormat":"blog/{slug}","template":"blog/_entry","language":"es"}}', '2021-03-15 16:32:15', '{"language":null,"mainEntityOfPage":"WebPage","seoTitle":"{entry.title}","siteNamePosition":"","seoDescription":"","seoKeywords":"","seoImage":"","seoImageWidth":"","seoImageHeight":"","seoImageDescription":"","canonicalUrl":"{entry.url}","robots":"","ogType":"website","ogTitle":"{seomatic.meta.seoTitle}","ogSiteNamePosition":"","ogDescription":"{seomatic.meta.seoDescription}","ogImage":"{seomatic.meta.seoImage}","ogImageWidth":"{seomatic.meta.seoImageWidth}","ogImageHeight":"{seomatic.meta.seoImageHeight}","ogImageDescription":"{seomatic.meta.seoImageDescription}","twitterCard":"summary_large_image","twitterCreator":"{seomatic.site.twitterHandle}","twitterTitle":"{seomatic.meta.seoTitle}","twitterSiteNamePosition":"","twitterDescription":"{seomatic.meta.seoDescription}","twitterImage":"{seomatic.meta.seoImage}","twitterImageWidth":"{seomatic.meta.seoImageWidth}","twitterImageHeight":"{seomatic.meta.seoImageHeight}","twitterImageDescription":"{seomatic.meta.seoImageDescription}","inherited":[],"overrides":[]}', '{"siteName":"Project","identity":null,"creator":null,"twitterHandle":"","facebookProfileId":"","facebookAppId":"","googleSiteVerification":"","bingSiteVerification":"","pinterestSiteVerification":"","facebookSiteVerification":"","sameAsLinks":[],"siteLinksSearchTarget":"","siteLinksQueryInput":"","referrer":"no-referrer-when-downgrade","additionalSitemapUrls":[],"additionalSitemapUrlsDateUpdated":null,"additionalSitemaps":[]}', '{"sitemapUrls":true,"sitemapAssets":true,"sitemapFiles":true,"sitemapAltLinks":true,"sitemapChangeFreq":"weekly","sitemapPriority":0.5,"sitemapLimit":null,"structureDepth":null,"sitemapImageFieldMap":[{"property":"title","field":"title"},{"property":"caption","field":""},{"property":"geo_location","field":""},{"property":"license","field":""}],"sitemapVideoFieldMap":[{"property":"title","field":"title"},{"property":"description","field":""},{"property":"thumbnailLoc","field":""},{"property":"duration","field":""},{"property":"category","field":""}],"inherited":[],"overrides":[]}', '{"MetaTagContainergeneral":{"data":[],"name":"General","description":"General Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTagContaineropengraph":{"data":[],"name":"Facebook","description":"Facebook OpenGraph Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"opengraph","include":true,"dependencies":[],"clearCache":false},"MetaTagContainertwitter":{"data":[],"name":"Twitter","description":"Twitter Card Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"twitter","include":true,"dependencies":[],"clearCache":false},"MetaTagContainermiscellaneous":{"data":[],"name":"Miscellaneous","description":"Miscellaneous Meta Tags","class":"nystudio107\\seomatic\\models\\MetaTagContainer","handle":"miscellaneous","include":true,"dependencies":[],"clearCache":false},"MetaLinkContainergeneral":{"data":[],"name":"General","description":"Link Tags","class":"nystudio107\\seomatic\\models\\MetaLinkContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaScriptContainergeneral":{"data":[],"position":1,"name":"General","description":"Script Tags","class":"nystudio107\\seomatic\\models\\MetaScriptContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaJsonLdContainergeneral":{"data":{"mainEntityOfPage":{"breadcrumb":null,"lastReviewed":null,"mainContentOfPage":null,"primaryImageOfPage":null,"relatedLink":null,"reviewedBy":null,"significantLink":null,"speakable":null,"specialty":null,"about":null,"abstract":null,"accessMode":null,"accessModeSufficient":null,"accessibilityAPI":null,"accessibilityControl":null,"accessibilityFeature":null,"accessibilityHazard":null,"accessibilitySummary":null,"accountablePerson":null,"acquireLicensePage":null,"aggregateRating":null,"alternativeHeadline":null,"associatedMedia":null,"audience":null,"audio":null,"author":{"id":"{parseEnv(seomatic.site.identity.genericUrl)}#identity"},"award":null,"character":null,"citation":null,"comment":null,"commentCount":null,"conditionsOfAccess":null,"contentLocation":null,"contentRating":null,"contentReferenceTime":null,"contributor":null,"copyrightHolder":{"id":"{parseEnv(seomatic.site.identity.genericUrl)}#identity"},"copyrightYear":"{entry.postDate | date(\"Y\")}","correction":null,"creativeWorkStatus":null,"creator":{"id":"{parseEnv(seomatic.site.identity.genericUrl)}#creator"},"dateCreated":false,"dateModified":"{entry.dateUpdated |atom}","datePublished":"{entry.postDate |atom}","discussionUrl":null,"editor":null,"educationalAlignment":null,"educationalUse":null,"encoding":null,"encodingFormat":null,"exampleOfWork":null,"expires":null,"funder":null,"genre":null,"hasPart":null,"headline":"{seomatic.meta.seoTitle}","inLanguage":"{seomatic.meta.language}","interactionStatistic":null,"interactivityType":null,"isAccessibleForFree":null,"isBasedOn":null,"isFamilyFriendly":null,"isPartOf":null,"keywords":null,"learningResourceType":null,"license":null,"locationCreated":null,"mainEntity":null,"maintainer":null,"material":null,"materialExtent":null,"mentions":null,"offers":null,"position":null,"producer":null,"provider":null,"publication":null,"publisher":{"id":"{parseEnv(seomatic.site.identity.genericUrl)}#creator"},"publisherImprint":null,"publishingPrinciples":null,"recordedAt":null,"releasedEvent":null,"review":null,"schemaVersion":null,"sdDatePublished":null,"sdLicense":null,"sdPublisher":null,"sourceOrganization":null,"spatial":null,"spatialCoverage":null,"sponsor":null,"temporal":null,"temporalCoverage":null,"text":null,"thumbnailUrl":null,"timeRequired":null,"translationOfWork":null,"translator":null,"typicalAgeRange":null,"usageInfo":null,"version":null,"video":null,"workExample":null,"workTranslation":null,"additionalType":null,"alternateName":null,"description":"{seomatic.meta.seoDescription}","disambiguatingDescription":null,"identifier":null,"image":{"type":"ImageObject","url":"{seomatic.meta.seoImage}"},"mainEntityOfPage":"{seomatic.meta.canonicalUrl}","name":"{seomatic.meta.seoTitle}","potentialAction":{"type":"SearchAction","target":"{seomatic.site.siteLinksSearchTarget}","query-input":"{seomatic.helper.siteLinksQueryInput()}"},"sameAs":null,"subjectOf":null,"url":"{seomatic.meta.canonicalUrl}","context":"http://schema.org","type":"{seomatic.meta.mainEntityOfPage}","id":null,"graph":null,"include":true,"key":"mainEntityOfPage","environment":null,"dependencies":null,"tagAttrs":[],"nonce":null}},"name":"General","description":"JsonLd Tags","class":"nystudio107\\seomatic\\models\\MetaJsonLdContainer","handle":"general","include":true,"dependencies":[],"clearCache":false},"MetaTitleContainergeneral":{"data":{"title":{"title":"{seomatic.meta.seoTitle}","siteName":"{seomatic.site.siteName}","siteNamePosition":"{seomatic.meta.siteNamePosition}","separatorChar":"{seomatic.config.separatorChar}","include":true,"key":"title","environment":null,"dependencies":null,"tagAttrs":[]}},"name":"General","description":"Meta Title Tag","class":"nystudio107\\seomatic\\models\\MetaTitleContainer","handle":"general","include":true,"dependencies":[],"clearCache":false}}', '[]', '{"data":[],"name":null,"description":null,"class":"nystudio107\\seomatic\\models\\FrontendTemplateContainer","handle":null,"include":true,"dependencies":null,"clearCache":false}', '{"siteType":"CreativeWork","siteSubType":"WebPage","siteSpecificType":"","seoTitleSource":"fromField","seoTitleField":"title","siteNamePositionSource":"sameAsGlobal","seoDescriptionSource":"fromCustom","seoDescriptionField":"","seoKeywordsSource":"fromCustom","seoKeywordsField":"","seoImageIds":[],"seoImageSource":"fromAsset","seoImageField":"","seoImageTransform":true,"seoImageTransformMode":"crop","seoImageDescriptionSource":"fromCustom","seoImageDescriptionField":"","twitterCreatorSource":"sameAsSite","twitterCreatorField":"","twitterTitleSource":"sameAsSeo","twitterTitleField":"","twitterSiteNamePositionSource":"sameAsGlobal","twitterDescriptionSource":"sameAsSeo","twitterDescriptionField":"","twitterImageIds":[],"twitterImageSource":"sameAsSeo","twitterImageField":"","twitterImageTransform":true,"twitterImageTransformMode":"crop","twitterImageDescriptionSource":"sameAsSeo","twitterImageDescriptionField":"","ogTitleSource":"sameAsSeo","ogTitleField":"","ogSiteNamePositionSource":"sameAsGlobal","ogDescriptionSource":"sameAsSeo","ogDescriptionField":"","ogImageIds":[],"ogImageSource":"sameAsSeo","ogImageField":"","ogImageTransform":true,"ogImageTransformMode":"crop","ogImageDescriptionSource":"sameAsSeo","ogImageDescriptionField":""}');
...
INSERT INTO public.users (id, username, "photoId", "firstName", "lastName", email, password, admin, locked, suspended, pending, "lastLoginDate", "lastLoginAttemptIp", "invalidLoginWindowStart", "invalidLoginCount", "lastInvalidLoginDate", "lockoutDate", "hasDashboard", "verificationCode", "verificationCodeIssuedDate", "unverifiedEmail", "passwordResetRequired", "lastPasswordChangeDate", "dateCreated", "dateUpdated", uid) VALUES (2, 'admin', NULL, '', '', 'andrew@nystudio107.com', '$2y$13$MSK16Tb4nffl25V/SibFe.VF9AJItEA/IBQ/yd5y/o6RCGw8l9HEm', true, false, false, false, '2022-03-17 16:36:43', NULL, NULL, NULL, NULL, NULL, true, NULL, NULL, NULL, false, '2021-03-15 16:24:54', '2021-03-01 00:43:19', '2022-03-17 16:36:43', 'ab28d292-9870-4921-8fbb-02727ab1ff31');
...
--
-- Name: calendar_calendar_sites_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.calendar_calendar_sites_id_seq', 2, true);


--
-- Name: calendar_calendars_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.calendar_calendars_id_seq', 1, true);


--
-- Name: calendar_events_internalId_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."calendar_events_internalId_seq"', 1, false);


--
-- Name: calendar_exceptions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.calendar_exceptions_id_seq', 1, false);


--
-- Name: calendar_select_dates_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.calendar_select_dates_id_seq', 1, false);
...
--
-- Name: digitalproducts_licenses_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.digitalproducts_licenses_id_seq', 1, false);


--
-- Name: digitalproducts_products_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.digitalproducts_products_id_seq', 1, false);


--
-- Name: digitalproducts_producttypes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.digitalproducts_producttypes_id_seq', 1, false);


--
-- Name: digitalproducts_producttypes_sites_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.digitalproducts_producttypes_sites_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.fieldlayoutfields_id_seq', 86, true);
...
SELECT pg_catalog.setval('public.fieldlayouttabs_id_seq', 53, true);
...
SELECT pg_catalog.setval('public.migrations_id_seq', 383, true);
...
SELECT pg_catalog.setval('public.plugins_id_seq', 33, true);
...
SELECT pg_catalog.setval('public.queue_id_seq', 128, true);
...
--
-- Name: calendar_calendar_sites calendar_calendar_sites_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_calendar_sites
    ADD CONSTRAINT calendar_calendar_sites_pkey PRIMARY KEY (id);


--
-- Name: calendar_calendars calendar_calendars_handle_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_calendars
    ADD CONSTRAINT calendar_calendars_handle_key UNIQUE (handle);


--
-- Name: calendar_calendars calendar_calendars_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.calendar_events
    ADD CONSTRAINT calendar_events_pkey PRIMARY KEY ("internalId");
...
--
-- Name: calendar_select_dates calendar_select_dates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_select_dates
    ADD CONSTRAINT calendar_select_dates_pkey PRIMARY KEY (id);
...
--
-- Name: digitalproducts_licenses digitalproducts_licenses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_licenses
    ADD CONSTRAINT digitalproducts_licenses_pkey PRIMARY KEY (id);


--
-- Name: digitalproducts_products digitalproducts_products_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_products
    ADD CONSTRAINT digitalproducts_products_pkey PRIMARY KEY (id);


--
-- Name: digitalproducts_producttypes digitalproducts_producttypes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_producttypes
    ADD CONSTRAINT digitalproducts_producttypes_pkey PRIMARY KEY (id);


--
-- Name: digitalproducts_producttypes_sites digitalproducts_producttypes_sites_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_producttypes_sites
    ADD CONSTRAINT digitalproducts_producttypes_sites_pkey PRIMARY KEY (id);
...
--
-- Name: calendar_calendar_sites_calendarId_siteId_unq_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "calendar_calendar_sites_calendarId_siteId_unq_idx" ON public.calendar_calendar_sites USING btree ("calendarId", "siteId");


--
-- Name: calendar_calendars_handle_unq_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX calendar_calendars_handle_unq_idx ON public.calendar_calendars USING btree (handle);


--
-- Name: calendar_calendars_icsHash_unq_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "calendar_calendars_icsHash_unq_idx" ON public.calendar_calendars USING btree ("icsHash");


--
-- Name: calendar_calendars_name_unq_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX calendar_calendars_name_unq_idx ON public.calendar_calendars USING btree (name);


--
-- Name: calendar_events_authorId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "calendar_events_authorId_idx" ON public.calendar_events USING btree ("authorId");


--
-- Name: calendar_events_calendarId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: calendar_events_endDate_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: calendar_events_id_unq_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX calendar_events_id_unq_idx ON public.calendar_events USING btree (id);


--
-- Name: calendar_events_postDate_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "calendar_events_postDate_idx" ON public.calendar_events USING btree ("postDate");


--
-- Name: calendar_events_startDate_endDate_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "calendar_events_startDate_endDate_idx" ON public.calendar_events USING btree ("startDate", "endDate");
...
--
-- Name: calendar_events_until_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX calendar_events_until_idx ON public.calendar_events USING btree (until);


--
-- Name: calendar_exceptions_exceptions_eventId_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "calendar_exceptions_exceptions_eventId_date_idx" ON public.calendar_exceptions USING btree ("eventId", date);


--
-- Name: calendar_select_dates_select_dates_eventId_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "calendar_select_dates_select_dates_eventId_date_idx" ON public.calendar_select_dates USING btree ("eventId", date);
...
CREATE INDEX idx_eryforlnsupwzgkcqdmdschyylzjlrqjqffu ON public.assettransformindex USING btree ("assetId", format, location);
...
--
-- Name: idx_grumxwubmzphkpbufsggaecmkpyzffqeuool; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_grumxwubmzphkpbufsggaecmkpyzffqeuool ON public.digitalproducts_licenses USING btree ("orderId");
...
--
-- Name: idx_icouacerxlwsglrdedtvgzmzxauuucefwhst; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_icouacerxlwsglrdedtvgzmzxauuucefwhst ON public.digitalproducts_producttypes USING btree (handle);
...
--
-- Name: idx_kugpqcxvzbgvniutoidhtdjzbisbsipxuweg; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_kugpqcxvzbgvniutoidhtdjzbisbsipxuweg ON public.digitalproducts_licenses USING btree ("licenseKey");
...
--
-- Name: idx_nbnjlsdzdmrkfyxdtglrfzgmcnubzifixgfm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_nbnjlsdzdmrkfyxdtglrfzgmcnubzifixgfm ON public.digitalproducts_producttypes USING btree ("fieldLayoutId");
...
--
-- Name: idx_qtfydydzbmcxmjgycfxmzgpejfqxzknxriot; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_qtfydydzbmcxmjgycfxmzgpejfqxzknxriot ON public.digitalproducts_producttypes_sites USING btree ("siteId");
...
--
-- Name: idx_rafyzunawtwmkefqmaerofodlcolhontlhch; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rafyzunawtwmkefqmaerofodlcolhontlhch ON public.digitalproducts_products USING btree ("typeId");
...
--
-- Name: idx_tnevuaaccazvxfailxxuizcrkgooutjtaspl; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_tnevuaaccazvxfailxxuizcrkgooutjtaspl ON public.digitalproducts_producttypes_sites USING btree ("productTypeId", "siteId");
...
--
-- Name: idx_ujhdxgzvolwldronpvvdjknzbudmffnlsjyr; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_ujhdxgzvolwldronpvvdjknzbudmffnlsjyr ON public.digitalproducts_products USING btree (sku);
...
--
-- Name: idx_wjoycykpvuwgvfthespbgbghknezpahipefx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_wjoycykpvuwgvfthespbgbghknezpahipefx ON public.digitalproducts_products USING btree ("taxCategoryId");
...
--
-- Name: idx_xcjnrcbocpbvdetrwjblmzxhywckqlwkkjfi; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_xcjnrcbocpbvdetrwjblmzxhywckqlwkkjfi ON public.digitalproducts_licenses USING btree ("productId");
...
--
-- Name: calendar_calendar_sites calendar_calendar_sites_calendarId_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_calendar_sites
    ADD CONSTRAINT "calendar_calendar_sites_calendarId_fk" FOREIGN KEY ("calendarId") REFERENCES public.calendar_calendars(id) ON DELETE CASCADE;


--
-- Name: calendar_calendar_sites calendar_calendar_sites_siteId_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_calendar_sites
    ADD CONSTRAINT "calendar_calendar_sites_siteId_fk" FOREIGN KEY ("siteId") REFERENCES public.sites(id) ON DELETE CASCADE;


--
-- Name: calendar_calendars calendar_calendars_fieldLayoutId_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_calendars
    ADD CONSTRAINT "calendar_calendars_fieldLayoutId_fk" FOREIGN KEY ("fieldLayoutId") REFERENCES public.fieldlayouts(id) ON DELETE SET NULL;


--
-- Name: calendar_events calendar_events_authorId_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_events
    ADD CONSTRAINT "calendar_events_authorId_fk" FOREIGN KEY ("authorId") REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: calendar_events calendar_events_calendarId_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_events
    ADD CONSTRAINT "calendar_events_calendarId_fk" FOREIGN KEY ("calendarId") REFERENCES public.calendar_calendars(id) ON DELETE CASCADE;


--
-- Name: calendar_events calendar_events_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_events
    ADD CONSTRAINT calendar_events_id_fk FOREIGN KEY (id) REFERENCES public.elements(id) ON DELETE CASCADE;


--
-- Name: calendar_exceptions calendar_exceptions_eventId_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_exceptions
    ADD CONSTRAINT "calendar_exceptions_eventId_fk" FOREIGN KEY ("eventId") REFERENCES public.calendar_events(id) ON DELETE CASCADE;


--
-- Name: calendar_select_dates calendar_select_dates_eventId_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.calendar_select_dates
    ADD CONSTRAINT "calendar_select_dates_eventId_fk" FOREIGN KEY ("eventId") REFERENCES public.calendar_events(id) ON DELETE CASCADE;
...
--
-- Name: digitalproducts_licenses fk_kacbhabxwlifbnusewuazmccimmraqahhzam; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_licenses
    ADD CONSTRAINT fk_kacbhabxwlifbnusewuazmccimmraqahhzam FOREIGN KEY ("userId") REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: digitalproducts_licenses fk_libvarcgvvvpngqnjlacleecyldfpapqhzoc; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_licenses
    ADD CONSTRAINT fk_libvarcgvvvpngqnjlacleecyldfpapqhzoc FOREIGN KEY ("orderId") REFERENCES public.commerce_orders(id) ON DELETE SET NULL;
...
--
-- Name: digitalproducts_licenses fk_lykgguwllxcrpgistlbzzkrsjeifqzrrsmqi; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_licenses
    ADD CONSTRAINT fk_lykgguwllxcrpgistlbzzkrsjeifqzrrsmqi FOREIGN KEY ("productId") REFERENCES public.digitalproducts_products(id) ON DELETE RESTRICT;
...
--
-- Name: digitalproducts_producttypes fk_nkfsbqygjkujsvrxsfhzkuyqmiymfgkpapmy; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_producttypes
    ADD CONSTRAINT fk_nkfsbqygjkujsvrxsfhzkuyqmiymfgkpapmy FOREIGN KEY ("fieldLayoutId") REFERENCES public.fieldlayouts(id) ON DELETE SET NULL;
...
--
-- Name: digitalproducts_products fk_ogmcwsvwlqjfhskaigcizwkovbecauznlwbz; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_products
    ADD CONSTRAINT fk_ogmcwsvwlqjfhskaigcizwkovbecauznlwbz FOREIGN KEY ("taxCategoryId") REFERENCES public.commerce_taxcategories(id) ON DELETE RESTRICT;
...
--
-- Name: digitalproducts_producttypes_sites fk_pkuocprdbrpbeioyqgfrtfdpohtjmbdjndus; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_producttypes_sites
    ADD CONSTRAINT fk_pkuocprdbrpbeioyqgfrtfdpohtjmbdjndus FOREIGN KEY ("productTypeId") REFERENCES public.digitalproducts_producttypes(id) ON DELETE CASCADE;


--
-- Name: digitalproducts_products fk_ppleoxacpikfervtzsgtivkbguqctefabrqp; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_products
    ADD CONSTRAINT fk_ppleoxacpikfervtzsgtivkbguqctefabrqp FOREIGN KEY (id) REFERENCES public.elements(id) ON DELETE CASCADE;
...
--
-- Name: digitalproducts_products fk_tzuvexgxamvllsduzupgpqogbxoeiygflxle; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_products
    ADD CONSTRAINT fk_tzuvexgxamvllsduzupgpqogbxoeiygflxle FOREIGN KEY ("typeId") REFERENCES public.digitalproducts_producttypes(id) ON DELETE CASCADE;
...
--
-- Name: digitalproducts_producttypes_sites fk_ulixbwgjigsixaochuqunjpeybdzfulegrpa; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_producttypes_sites
    ADD CONSTRAINT fk_ulixbwgjigsixaochuqunjpeybdzfulegrpa FOREIGN KEY ("siteId") REFERENCES public.sites(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: digitalproducts_licenses fk_wtxvkowaoasmyzfvxvufcfbewmisdggpkiww; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digitalproducts_licenses
    ADD CONSTRAINT fk_wtxvkowaoasmyzfvxvufcfbewmisdggpkiww FOREIGN KEY (id) REFERENCES public.elements(id) ON DELETE CASCADE;
