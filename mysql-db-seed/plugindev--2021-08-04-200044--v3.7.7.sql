...
CREATE TABLE `announcements` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_czskgaknxmynlzalejglevijgzmtudbfdrno` (`userId`,`unread`,`dateRead`,`dateCreated`),
  KEY `idx_weaubuxtvhlucwpnghqucmdflrvrriydbbxm` (`dateRead`),
  KEY `fk_bfdhqorljrosyczmqckxbvsuywdcadicxevu` (`pluginId`),
  CONSTRAINT `fk_bfdhqorljrosyczmqckxbvsuywdcadicxevu` FOREIGN KEY (`pluginId`) REFERENCES `plugins` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_iibnglkxemzghrbbimyopozemmqyeenohsbe` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `campaign_campaigns`
--

DROP TABLE IF EXISTS `campaign_campaigns`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_campaigns` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_hmdxylvcohhijgenyksjxyjsfrbridzgsuaf` (`campaignTypeId`),
  CONSTRAINT `fk_dpvwopkquflrlrbvqytggjfunjjpydylrtgc` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_hmdxylvcohhijgenyksjxyjsfrbridzgsuaf` FOREIGN KEY (`campaignTypeId`) REFERENCES `campaign_campaigntypes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `campaign_campaigntypes`
--

DROP TABLE IF EXISTS `campaign_campaigntypes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_campaigntypes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `siteId` int NOT NULL,
  ...
  `handle` varchar(255) NOT NULL,
  `uriFormat` text,
  `htmlTemplate` varchar(500) DEFAULT NULL,
  `plaintextTemplate` varchar(500) DEFAULT NULL,
  `queryStringParameters` text,
  `testContactId` int DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_pwcgjxomqtplqutvgrsqlxkelbkccesuqlrf` (`handle`),
  KEY `fk_toguslklbmzyswrabrsjhvpmcsyqsuaxpuzm` (`siteId`),
  KEY `fk_pahiqmytzgyocfmmfcqxddkaoeguppcvcxfm` (`fieldLayoutId`),
  KEY `fk_icsmeywemcyofrdchcnsltlecodjbazwncui` (`testContactId`),
  CONSTRAINT `fk_icsmeywemcyofrdchcnsltlecodjbazwncui` FOREIGN KEY (`testContactId`) REFERENCES `campaign_contacts` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_pahiqmytzgyocfmmfcqxddkaoeguppcvcxfm` FOREIGN KEY (`fieldLayoutId`) REFERENCES `fieldlayouts` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_toguslklbmzyswrabrsjhvpmcsyqsuaxpuzm` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `campaign_contacts` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_wqqkxtrjsdjqpsdcdqmnpjulrzrgwfaqovkj` (`cid`),
  KEY `idx_jqhrpgusayohgkbaputlsxsfnnhrrwchokmz` (`email`),
  KEY `fk_dxrblztwuxvfakkvacygynlikwuqesrapezm` (`userId`),
  CONSTRAINT `fk_dxrblztwuxvfakkvacygynlikwuqesrapezm` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_vhqqfuhoznpdtgirovrtbritcjiqwplqdazm` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `campaign_contacts_campaigns`
--

DROP TABLE IF EXISTS `campaign_contacts_campaigns`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_contacts_campaigns` (
  `id` int NOT NULL AUTO_INCREMENT,
  `contactId` int NOT NULL,
  `campaignId` int NOT NULL,
  `sendoutId` int NOT NULL,
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_htvrdvmmtpzfioreqiaxwhfhnwrowriyjhzm` (`contactId`,`sendoutId`),
  KEY `fk_sxxbcwktptibavyxqyjlbfxgjgjhojfbbcmw` (`campaignId`),
  CONSTRAINT `fk_sxxbcwktptibavyxqyjlbfxgjgjhojfbbcmw` FOREIGN KEY (`campaignId`) REFERENCES `campaign_campaigns` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_waaapraehewhnlsbtqiasbxfgxaniwdtcqgo` FOREIGN KEY (`contactId`) REFERENCES `campaign_contacts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `campaign_contacts_mailinglists`
--

DROP TABLE IF EXISTS `campaign_contacts_mailinglists`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_contacts_mailinglists` (
  `id` int NOT NULL AUTO_INCREMENT,
  `contactId` int NOT NULL,
  `mailingListId` int NOT NULL,
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_wyfoegdrkoscjwjyqizvtozrwalpmsfypekt` (`contactId`,`mailingListId`),
  KEY `idx_uzajbnzmfxtmiohscbuexmauorsxtcvpcloj` (`subscriptionStatus`),
  KEY `fk_sulzbybzzxeccwxoaylipkiucqfchroccaio` (`mailingListId`),
  CONSTRAINT `fk_hgbjnpwiiqqwjfssxfocmiqsglgjkgvdkjjf` FOREIGN KEY (`contactId`) REFERENCES `campaign_contacts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_sulzbybzzxeccwxoaylipkiucqfchroccaio` FOREIGN KEY (`mailingListId`) REFERENCES `campaign_mailinglists` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `campaign_imports`
--
...
CREATE TABLE `campaign_imports` (
  ...
  `userId` int DEFAULT NULL,
  `mailingListId` int DEFAULT NULL,
  `forceSubscribe` tinyint(1) NOT NULL DEFAULT '0',
  `emailFieldIndex` varchar(255) DEFAULT NULL,
  `fieldIndexes` text,
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_turqkxxxxzamgskibxdakmyrmnvbzxwrrrkr` (`userId`),
  KEY `fk_jklcsoxkcinbnvdcjqaldpzwxkoiayyrveut` (`mailingListId`),
  CONSTRAINT `fk_jklcsoxkcinbnvdcjqaldpzwxkoiayyrveut` FOREIGN KEY (`mailingListId`) REFERENCES `campaign_mailinglists` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_turqkxxxxzamgskibxdakmyrmnvbzxwrrrkr` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `campaign_links` (
  `id` int NOT NULL AUTO_INCREMENT,
  `lid` char(17) NOT NULL DEFAULT '0',
  `campaignId` int NOT NULL,
  `url` text,
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_bzrrtstpkutahygnnfaqxpuvrzczbbosgnjv` (`lid`),
  KEY `fk_egxswcqttblexkpxggsauzoxdfkpwzcgajms` (`campaignId`),
  CONSTRAINT `fk_egxswcqttblexkpxggsauzoxdfkpwzcgajms` FOREIGN KEY (`campaignId`) REFERENCES `campaign_campaigns` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `campaign_mailinglists`
--

DROP TABLE IF EXISTS `campaign_mailinglists`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_mailinglists` (
  `id` int NOT NULL AUTO_INCREMENT,
  `mailingListTypeId` int NOT NULL,
  `syncedUserGroupId` int DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_ssmujjgqjkpmxmuubnalvuehvhjjboatdltv` (`mailingListTypeId`),
  KEY `fk_igmuwkflvmnnimivmpdyyuagpolhtmxedycl` (`syncedUserGroupId`),
  CONSTRAINT `fk_gmegrprliavcxnqkbnvpdddezmcnvxalrqof` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_igmuwkflvmnnimivmpdyyuagpolhtmxedycl` FOREIGN KEY (`syncedUserGroupId`) REFERENCES `usergroups` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_ssmujjgqjkpmxmuubnalvuehvhjjboatdltv` FOREIGN KEY (`mailingListTypeId`) REFERENCES `campaign_mailinglisttypes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `campaign_mailinglisttypes`
--

DROP TABLE IF EXISTS `campaign_mailinglisttypes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_mailinglisttypes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `siteId` int NOT NULL,
  `fieldLayoutId` int DEFAULT NULL,
  `name` varchar(255) NOT NULL,
  `handle` varchar(255) NOT NULL,
  `subscribeVerificationRequired` tinyint(1) NOT NULL DEFAULT '1',
  `subscribeVerificationEmailSubject` text,
  `subscribeVerificationEmailTemplate` varchar(500) DEFAULT NULL,
  `subscribeVerificationSuccessTemplate` varchar(500) DEFAULT NULL,
  `subscribeSuccessTemplate` varchar(500) DEFAULT NULL,
  `unsubscribeFormAllowed` tinyint(1) NOT NULL DEFAULT '0',
  `unsubscribeVerificationEmailSubject` text,
  `unsubscribeVerificationEmailTemplate` varchar(500) DEFAULT NULL,
  `unsubscribeSuccessTemplate` varchar(500) DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_svnmcovixynidwuvtmzkqweiouqfolvlpdcx` (`handle`),
  KEY `fk_mtepzgiwxhhefjnhimzftcypzasybtcjgnoo` (`siteId`),
  KEY `fk_iwwbtvuzeqjkixgykzhlzighrbzmeysucair` (`fieldLayoutId`),
  CONSTRAINT `fk_iwwbtvuzeqjkixgykzhlzighrbzmeysucair` FOREIGN KEY (`fieldLayoutId`) REFERENCES `fieldlayouts` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_mtepzgiwxhhefjnhimzftcypzasybtcjgnoo` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `campaign_pendingcontacts`
--

DROP TABLE IF EXISTS `campaign_pendingcontacts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_pendingcontacts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `pid` char(17) NOT NULL DEFAULT '0',
  `email` varchar(255) NOT NULL,
  `mailingListId` int NOT NULL,
  `source` varchar(255) DEFAULT NULL,
  `fieldData` text,
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_arwilciwmrvdknmpthtavasupgpotbuadamp` (`pid`),
  KEY `idx_baycxqeztjaxehtboeavcbepikjqqcreiqft` (`email`,`mailingListId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `campaign_segments` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_ubejxbirrqlaeyzqlsiegylofsjdmfujvsmb` (`segmentType`),
  CONSTRAINT `fk_jqnuenlxwtcimywpfywvgsykyzuztdpcnasp` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `campaign_sendouts`
--

DROP TABLE IF EXISTS `campaign_sendouts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_sendouts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `sid` char(17) NOT NULL DEFAULT '0',
  `campaignId` int DEFAULT NULL,
  `senderId` int DEFAULT NULL,
  `sendoutType` varchar(255) NOT NULL,
  `sendStatus` varchar(255) NOT NULL,
  `fromName` varchar(255) NOT NULL,
  `fromEmail` varchar(255) NOT NULL,
  `replyToEmail` varchar(255) DEFAULT NULL,
  `subject` text,
  `notificationEmailAddress` varchar(255) DEFAULT NULL,
  `mailingListIds` text,
  `excludedMailingListIds` text,
  `segmentIds` text,
  `recipients` int NOT NULL DEFAULT '0',
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_kufdxhcojfowuheoycfjyyzkmmjuczemnkmb` (`sid`),
  KEY `idx_rykamncuqislwfqpgbntpjvzsqgyrwjwewep` (`sendoutType`),
  KEY `idx_wpqbdoqtqnlyeuajmvhuomzpxfotveojutoj` (`sendStatus`),
  KEY `fk_busldajdqauzfdoqqbwrsohoebqvuasnjrak` (`campaignId`),
  KEY `fk_lpemtkfnwtasjkdqgixzcrrlfckfbnajuxtr` (`senderId`),
  CONSTRAINT `fk_busldajdqauzfdoqqbwrsohoebqvuasnjrak` FOREIGN KEY (`campaignId`) REFERENCES `campaign_campaigns` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_lpemtkfnwtasjkdqgixzcrrlfckfbnajuxtr` FOREIGN KEY (`senderId`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_slwhcsasnhtmwlaijgwtmfeyagcbbeeaxoff` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `commerce_addresses` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_hpfuomyomxmphcpvwvizevsykezlpioywpbs` (`countryId`),
  KEY `idx_esxghmzxolmoclpotqebrnmyvheiyhksyhbg` (`stateId`),
  KEY `idx_czjhkkjcppxayfrfhbycmrbybvlxttaojrwg` (`isStoreLocation`),
  CONSTRAINT `fk_kyghfhoxtzfzlurmtmitisgksiihmbegqfyk` FOREIGN KEY (`countryId`) REFERENCES `commerce_countries` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_rnihovfikjqskwmhlqaifwwlmfpifrycbewy` FOREIGN KEY (`stateId`) REFERENCES `commerce_states` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `commerce_ordernotices` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_mdknvybyrhnabpwlqfvtltiqooxnahysbffc` (`orderId`),
  CONSTRAINT `fk_ynxntkxnnlpajvouxbgghyqrbdskkqmifsvx` FOREIGN KEY (`orderId`) REFERENCES `commerce_orders` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `drafts` (
  ...
  KEY `idx_lwnvnrcdqxugcddhryroxakwjziwpkbnayny` (`creatorId`,`provisional`),
...
CREATE TABLE `elements` (
  ...
  KEY `fk_taxjvifqgffkigrfbxbklmtlosvozobblccg` (`canonicalId`),
  ...
  CONSTRAINT `fk_taxjvifqgffkigrfbxbklmtlosvozobblccg` FOREIGN KEY (`canonicalId`) REFERENCES `elements` (`id`) ON DELETE SET NULL
...
CREATE TABLE `entries` (
  ...
  CONSTRAINT `fk_oscpwzvcuzhzfksdbfoljigocawxsvekvxtn` FOREIGN KEY (`authorId`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_forms` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_etiyankgvxhlwdefhvxbwnxnzsrltnrtlomz` (`templateId`),
  KEY `idx_vqczeajhywijynklmokczaluekjsynjyclvv` (`defaultStatusId`),
  KEY `idx_ggqetfqtxwycvncxvzwjezdrvdhwtnnwwtwo` (`submitActionEntryId`),
  KEY `idx_vffwiuliyuffomejhhequdboxyfulideimiq` (`fieldLayoutId`),
  CONSTRAINT `fk_fitixpllmociehkmlrubiqaiftmzmvcsjsie` FOREIGN KEY (`defaultStatusId`) REFERENCES `formie_statuses` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_hsgjcaonxlolosmmlcwfcwpgzanookoswmbo` FOREIGN KEY (`templateId`) REFERENCES `formie_formtemplates` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_kekmyobzycebwglazkaajzwokfbmcursxuwi` FOREIGN KEY (`submitActionEntryId`) REFERENCES `entries` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_ulbgfsdltjmnjwqeiinhmqjjqbqyqzaatgxx` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_wsolpmdbqeswioblkoxpnbfprmmdauxrzrka` FOREIGN KEY (`fieldLayoutId`) REFERENCES `fieldlayouts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_formtemplates` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_kdumzhocvelbamrvdfuisnautquwjwxcpswi` (`fieldLayoutId`),
  CONSTRAINT `fk_ohrwangihcazwqxsheeonotswngbdmmcufvd` FOREIGN KEY (`fieldLayoutId`) REFERENCES `fieldlayouts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_nested` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_euxpmeoqwgtoyqhfhmxziochsymmqblxdxxz` (`fieldId`),
  KEY `idx_eqhalzvucydiczjagxykauqmnfpexdzibaab` (`fieldLayoutId`),
  CONSTRAINT `fk_xsqnqauyxozoikzltppfusvlapwnvucvgygf` FOREIGN KEY (`fieldId`) REFERENCES `fields` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_xweijrkbhtulxqkjqszpntrlgwpdrjdnwkqv` FOREIGN KEY (`fieldLayoutId`) REFERENCES `fieldlayouts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_nestedfieldrows` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_zkomvlgockpnzxhdesgybxumqqgqokwldcml` (`ownerId`),
  KEY `idx_fukleuebaxyjdojmjdnratoapejkaokxypvg` (`fieldId`),
  KEY `idx_vlrfbtnjxdeutrlgevjqryvugcyftccrcepz` (`sortOrder`),
  CONSTRAINT `fk_fybqertwvodtgxwwpgboxejojndjxyxmtpsj` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_ilwytnmrjazadfkmwfyzdboqplherxcwhedw` FOREIGN KEY (`ownerId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_rkdjdvyearhcdovayyvzwbfcmlvptlrdozda` FOREIGN KEY (`fieldId`) REFERENCES `fields` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_notifications` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_wnawebinamnghbgvdswwaruokeffsnxbtlcw` (`formId`),
  KEY `idx_zyinjxszruftunvekxwwiwdcltvunvslafpq` (`templateId`),
  CONSTRAINT `fk_cgcknpivtchktlulqxlhbpgswbbvudoervur` FOREIGN KEY (`templateId`) REFERENCES `formie_emailtemplates` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_jndxuhjewlemttvtojkafqqnlwdpsycoxzsr` FOREIGN KEY (`formId`) REFERENCES `formie_forms` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_pagesettings` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_zfumdjpchsyzzqtavqsjbtkfafkbobsycgzr` (`fieldLayoutTabId`),
  KEY `idx_hyxhakuamuuommoyxdcydiiibutumatojbov` (`fieldLayoutId`),
  CONSTRAINT `fk_gfmwhafwdtyloncyonuqtxbnblnhfwpvyfpv` FOREIGN KEY (`fieldLayoutId`) REFERENCES `fieldlayouts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_nqhfmoinhnpqhticeiimpfghlrurfciytpzk` FOREIGN KEY (`fieldLayoutTabId`) REFERENCES `fieldlayouttabs` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_relations` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_znyrcauwrgupedqayjvdpogjpwcgbjrdtjqh` (`sourceId`,`sourceSiteId`,`targetId`),
  KEY `idx_gwfmnnxaoneoihtfmlxzmrlrjpxdlzqcofta` (`sourceId`),
  KEY `idx_hcgxxsllacyxkoxzhtzviokilyquavjmslbg` (`targetId`),
  KEY `idx_fuzkwufaqberuxbqygwaiblfsxewlwefxnac` (`sourceSiteId`),
  CONSTRAINT `fk_chinnncznzjplsbbkzxwqhgwryzvblvgxqei` FOREIGN KEY (`sourceId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_teghzvpwisecqmsljmdnhxptgvchinnpfbfw` FOREIGN KEY (`sourceSiteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_xzbrhqbisqzjghbpqkkotlrubagduzgdibwa` FOREIGN KEY (`targetId`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_rows` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_zjciysvrectvtxsxtentnwrsfxaygcuqenqr` (`fieldLayoutFieldId`),
  KEY `idx_peotyhjpydhnotgjhntgwepleapyoqknyxkn` (`fieldLayoutId`),
  CONSTRAINT `fk_lnhfxnlgchezicqbhlkeudezbiqlcnlmmefr` FOREIGN KEY (`fieldLayoutFieldId`) REFERENCES `fieldlayoutfields` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_zdlypyjausrcuhiyqrlqpcijzvovutibtttu` FOREIGN KEY (`fieldLayoutId`) REFERENCES `fieldlayouts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_sentnotifications` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_tzkcyeqamsjduazrecxrhzakuwoitzotvboi` (`formId`),
  KEY `fk_srmxdeymwjbcumorgrttitwrzdhlwehmmrfj` (`submissionId`),
  KEY `fk_knimrnxyhddtexexdtnymqqeqtaehwengfec` (`notificationId`),
  CONSTRAINT `fk_cdhdbjhhzrlunjyfrtllenhjcmzpfklgocll` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_knimrnxyhddtexexdtnymqqeqtaehwengfec` FOREIGN KEY (`notificationId`) REFERENCES `formie_notifications` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_srmxdeymwjbcumorgrttitwrzdhlwehmmrfj` FOREIGN KEY (`submissionId`) REFERENCES `formie_submissions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_tzkcyeqamsjduazrecxrhzakuwoitzotvboi` FOREIGN KEY (`formId`) REFERENCES `formie_forms` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_stencils` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_gyfdcxjwmuzxoesnnlsjsuopeapgfiyvysgn` (`templateId`),
  KEY `idx_pvauaacyvqbvzrdzjrjsaonntpswolaiuzra` (`defaultStatusId`),
  CONSTRAINT `fk_vlknmqwbqxutxqzrvfxcgksyaqieloyowxvi` FOREIGN KEY (`templateId`) REFERENCES `formie_formtemplates` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_xubhemuwierbrbnislmeuemgtmgddiwkqruq` FOREIGN KEY (`defaultStatusId`) REFERENCES `formie_statuses` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_submissions` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_yceodiencligmjdwiqcxzgztuvpsazfpivqo` (`formId`),
  KEY `idx_urwxrvaceqkwsfbgihxwucxlwgxrryksmzdf` (`statusId`),
  KEY `idx_ywhuwjizroofocittioqifwcehectiylkpoz` (`userId`),
  CONSTRAINT `fk_fzszohqoyjcyeeejmqaypprjctpyeuulkasj` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_kjuyhzgochjbnvsrhwpfbwyvrlwzdvpslyac` FOREIGN KEY (`formId`) REFERENCES `formie_forms` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_lmabtzqkfndbbtqasyiaehrpjuhsjqumsqjz` FOREIGN KEY (`statusId`) REFERENCES `formie_statuses` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_ydgafxekiuexgbpkzgjoeefwsxkgsgqdgidz` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_syncfields` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_nurznkbmmsvrrfmarxvmkshtabcrejsbacnc` (`syncId`,`fieldId`),
  KEY `fk_wjwurehomafcjqzjphztzqxfxsbrybjigeuj` (`fieldId`),
  CONSTRAINT `fk_oawwnlkdumzvrjzdwnqcxurnjqnikelyprpa` FOREIGN KEY (`syncId`) REFERENCES `formie_syncs` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_wjwurehomafcjqzjphztzqxfxsbrybjigeuj` FOREIGN KEY (`fieldId`) REFERENCES `fields` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `globalsets` (
  ...
  KEY `idx_tsrdxzrifmokfdcfnktasntujdvcdeljxudm` (`sortOrder`),
...
-- Dump completed on 2021-08-04 20:00:45
-- MariaDB dump 10.19  Distrib 10.5.11-MariaDB, for Linux (x86_64)
--
-- Host: mysql    Database: project
-- ------------------------------------------------------
...
set autocommit=0;
INSERT INTO `announcements` VALUES (1,1,NULL,'Editor Slideouts','Double-click entries and other editable elements to try the new editor slideout interface.',0,'2021-08-04 19:58:23','2021-07-14 16:09:09'),(2,1,NULL,'Streamlined Entry Publishing Flow','The entry publishing workflow is now [simpler and more intuitive](https://craftcms.com/knowledge-base/editing-entries).',0,'2021-08-04 19:58:23','2021-07-14 16:09:09');
...
set autocommit=0;
INSERT INTO `assets` VALUES (23,1,1,1,'brazzers-launch.jpeg','image',3000,2250,762071,NULL,NULL,NULL,'2021-07-14 16:33:03','2021-07-14 16:33:03','2021-07-14 16:33:03','25a0b096-2f9e-4ec9-9339-67646e17bd4d');
...
--
-- Dumping data for table `campaign_campaigns`
--

LOCK TABLES `campaign_campaigns` WRITE;
/*!40000 ALTER TABLE `campaign_campaigns` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_campaigns` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Dumping data for table `campaign_campaigntypes`
--

LOCK TABLES `campaign_campaigntypes` WRITE;
/*!40000 ALTER TABLE `campaign_campaigntypes` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_campaigntypes` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Dumping data for table `campaign_contacts_campaigns`
--

LOCK TABLES `campaign_contacts_campaigns` WRITE;
/*!40000 ALTER TABLE `campaign_contacts_campaigns` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_contacts_campaigns` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Dumping data for table `campaign_contacts_mailinglists`
--

LOCK TABLES `campaign_contacts_mailinglists` WRITE;
/*!40000 ALTER TABLE `campaign_contacts_mailinglists` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_contacts_mailinglists` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Dumping data for table `campaign_imports`
--

LOCK TABLES `campaign_imports` WRITE;
/*!40000 ALTER TABLE `campaign_imports` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_imports` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
LOCK TABLES `campaign_links` WRITE;
/*!40000 ALTER TABLE `campaign_links` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_links` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Dumping data for table `campaign_mailinglists`
--

LOCK TABLES `campaign_mailinglists` WRITE;
/*!40000 ALTER TABLE `campaign_mailinglists` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_mailinglists` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Dumping data for table `campaign_mailinglisttypes`
--

LOCK TABLES `campaign_mailinglisttypes` WRITE;
/*!40000 ALTER TABLE `campaign_mailinglisttypes` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_mailinglisttypes` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Dumping data for table `campaign_pendingcontacts`
--

LOCK TABLES `campaign_pendingcontacts` WRITE;
/*!40000 ALTER TABLE `campaign_pendingcontacts` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_pendingcontacts` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Dumping data for table `campaign_sendouts`
--

LOCK TABLES `campaign_sendouts` WRITE;
/*!40000 ALTER TABLE `campaign_sendouts` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `campaign_sendouts` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT INTO `categorygroups` VALUES (1,1,9,'Category','category','end','2021-04-01 02:35:21','2021-04-01 02:35:21','2021-06-15 15:48:25','1cc0f175-5212-4568-94a6-9598fce64b6c'),(2,2,10,'Category','category','end','2021-06-15 15:48:25','2021-06-15 15:48:25',NULL,'b8fd3909-9af1-42c4-8c5e-2716a2a1957e');
...
set autocommit=0;
INSERT INTO `categorygroups_sites` VALUES (1,1,1,1,'category/{slug}',NULL,'2021-04-01 02:35:21','2021-04-01 02:35:21','3282a3d5-150f-4c6e-a411-83853f570db1'),(2,1,2,1,'category/{slug}',NULL,'2021-04-01 02:35:21','2021-04-01 02:35:21','686ceccf-7a6a-4c74-9a45-e1fd333a203d'),(3,2,1,1,'category/{slug}',NULL,'2021-06-15 15:48:25','2021-06-15 15:48:25','c8b20b2c-c9d2-4936-a842-3b840b837653'),(4,2,2,1,'category/{slug}',NULL,'2021-06-15 15:48:25','2021-06-15 15:48:25','d2620963-3d69-43c5-92ca-28c6cf61f32d');
...
set autocommit=0;
INSERT INTO `changedattributes` VALUES (1,1,'firstName','2021-03-15 14:57:00',0,1),(1,1,'lastName','2021-03-15 14:57:00',0,1),(1,1,'lastPasswordChangeDate','2021-03-15 14:57:00',0,1),(1,1,'password','2021-03-15 14:57:00',0,1),(2,1,'fieldLayoutId','2021-03-03 22:29:11',0,1),(25,1,'fieldLayoutId','2021-07-22 14:16:02',0,1),(25,1,'slug','2021-07-19 15:54:10',0,1),(25,1,'title','2021-07-19 15:54:10',0,1),(25,1,'typeId','2021-07-22 14:16:02',0,1),(25,1,'uri','2021-07-19 15:54:10',0,1),(25,2,'fieldLayoutId','2021-07-19 15:53:58',1,1),(25,2,'slug','2021-07-19 15:54:10',1,1),(25,2,'title','2021-07-19 15:54:10',1,1),(25,2,'typeId','2021-07-19 15:53:58',1,1),(25,2,'uri','2021-07-19 15:54:10',1,1);
...
set autocommit=0;
INSERT INTO `changedfields` VALUES (2,1,5,'2021-03-15 15:11:47',0,NULL),(2,2,5,'2021-03-15 15:11:47',1,NULL),(17,1,6,'2021-03-15 16:17:37',0,1),(17,2,6,'2021-03-15 16:17:37',1,1),(25,1,5,'2021-07-28 15:49:22',0,1),(25,1,6,'2021-07-22 14:15:46',0,1),(25,1,7,'2021-07-19 15:54:15',0,1),(25,1,8,'2021-07-28 15:49:22',0,1),(25,2,5,'2021-07-28 15:49:22',1,1),(25,2,6,'2021-07-22 14:15:46',1,1),(25,2,7,'2021-07-19 15:54:15',1,1),(25,2,8,'2021-07-28 15:49:22',1,1);
...
set autocommit=0;
INSERT INTO `formie_statuses` VALUES (1,'New','new','green',NULL,1,1,NULL,'2021-06-15 15:48:25','2021-06-15 15:48:25','110568c4-6978-4a9d-ae96-44c45c0739c1');
...
set autocommit=0;
INSERT INTO `globalsets` VALUES (19,'Globals','globals',6,2,'2021-03-15 15:55:30','2021-07-14 16:08:59','aa7c6968-88ec-4d2a-af47-d3c40b582a68');
...
set autocommit=0;
INSERT INTO `info` VALUES (1,'3.7.7','3.7.7',0,'exrynxbucntv','luzmvhykhscq','2020-03-27 13:22:43','2021-08-04 19:57:58','85f4c669-6b2b-4771-976e-a4bcdd2bd77b');
...
set autocommit=0;
INSERT INTO `retour_static_redirects` VALUES (1,'2021-07-05 19:41:25','2021-07-05 19:41:25','b63100c2-8c60-4590-9437-3f508984b756',NULL,0,1,'/mooo','/mooo','pathonly','exactmatch','/bark',301,0,NULL),(2,'2021-07-06 17:48:14','2021-07-06 17:48:14','be237a53-f79a-4350-9d31-8101da36cb3c',NULL,0,1,'/cow','/cow','pathonly','exactmatch','/man',301,0,NULL);
...
set autocommit=0;
INSERT INTO `revisions` VALUES (1,17,1,1,''),(2,17,1,2,''),(3,25,1,1,''),(4,25,1,2,'Applied “Draft 1”'),(5,25,1,3,''),(6,25,1,4,''),(7,25,1,5,''),(8,25,1,6,''),(9,25,1,7,''),(10,25,1,8,''),(11,25,1,9,'');
...
set autocommit=0;
INSERT INTO `structureelements` VALUES (1,1,NULL,1,1,2,0,'2021-04-01 02:35:35','2021-06-15 15:48:25','49453ac8-b940-462b-9de9-8b45aa3efa99');
...
set autocommit=0;
INSERT INTO `structures` VALUES (1,NULL,'2021-04-01 02:35:21','2021-04-01 02:35:21','2021-06-15 15:48:25','720df5b4-5784-490a-b196-dcbd886a2803'),(2,NULL,'2021-06-15 15:48:25','2021-06-15 15:48:25',NULL,'7955d443-a120-44f2-bdbe-c741d59fadf4');
...
set autocommit=0;
INSERT INTO `userpermissions` VALUES (1,'formie-viewforms','2021-07-14 16:09:00','2021-07-14 16:09:00','f873c363-277f-41a2-a51d-77a55f9c9f67');
...
set autocommit=0;
INSERT INTO `userpreferences` VALUES (1,'{\"language\":\"en-US\",\"locale\":null,\"weekStartDay\":\"1\",\"useShapes\":false,\"underlineLinks\":false,\"showFieldHandles\":true,\"enableDebugToolbarForSite\":true,\"enableDebugToolbarForCp\":true,\"showExceptionView\":false,\"profileTemplates\":false}');
...
-- Dump completed on 2021-08-04 20:00:46
